...
class JSON::LD::Context
  add_preloaded("http://prefix.cc/context") do
    new(processingMode: "json-ld-1.1", term_definitions: {
      ...
      "cts" => TermDefinition.new("cts", id: "http://rdf.cdisc.org/sdtm-terminology#", simple: true, prefix: true),
      ...
      "r2rml" => TermDefinition.new("r2rml", id: "http://mrdmexample.com/test#", simple: true, prefix: true),
