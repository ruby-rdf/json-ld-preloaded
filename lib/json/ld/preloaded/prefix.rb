...
class JSON::LD::Context
  add_preloaded("http://prefix.cc/context") do
    new(term_definitions: {
      ...
      "bl" => TermDefinition.new("bl", id: "http://w3id.org/biolink/vocab/", simple: true, prefix: true),
      ...
      "leak" => TermDefinition.new("leak", id: "http://data.ontotext.com/resource/leaks#", simple: true, prefix: true),
