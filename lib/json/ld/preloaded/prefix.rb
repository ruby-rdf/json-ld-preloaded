...
class JSON::LD::Context
  add_preloaded("http://prefix.cc/context") do
    new(processingMode: "json-ld-1.1", term_definitions: {
      ...
      "daap" => TermDefinition.new("daap", id: "http://daap.eu/wiki/", simple: true, prefix: true),
      ...
      "leak" => TermDefinition.new("leak", id: "http://maco.com/", simple: true, prefix: true),
      ...
      "mr" => TermDefinition.new("mr", id: "http://marineregions.org/mrgid/", simple: true, prefix: true),
