...
class JSON::LD::Context
  add_preloaded("http://prefix.cc/context") do
    new(processingMode: "json-ld-1.1", term_definitions: {
      ...
      "accid" => TermDefinition.new("accid", id: "http://pid.accurids.com/", simple: true, prefix: true),
      ...
      "acp" => TermDefinition.new("acp", id: "http://www.w3.org/ns/solid/acp#", simple: true, prefix: true),
      ...
      "activity" => TermDefinition.new("activity", id: "https://www.w3.org/TR/activitystreams-vocabulary/", simple: true, prefix: true),
      ...
      "adr" => TermDefinition.new("adr", id: "http://kg.artsdata.ca/resource/", simple: true, prefix: true),
      "aec3po" => TermDefinition.new("aec3po", id: "https://w3id.org/lbd/aec3po/", simple: true, prefix: true),
      ...
      "aff" => TermDefinition.new("aff", id: "https://w3id.org/affectedBy#", simple: true, prefix: true),
      ...
      "afn" => TermDefinition.new("afn", id: "http://jena.apache.org/ARQ/function#", simple: true, prefix: true),
      ...
      "agro" => TermDefinition.new("agro", id: "http://purl.obolibrary.org/obo/agro.owl#", simple: true, prefix: true),
      "agrovoc" => TermDefinition.new("agrovoc", id: "http://aims.fao.org/aos/agrovoc/", simple: true, prefix: true),
      "ags" => TermDefinition.new("ags", id: "https://id.agschemas.org/", simple: true, prefix: true),
      ...
      "ammo" => TermDefinition.new("ammo", id: "http://ldf.fi/schema/ammo/", simple: true, prefix: true),
      "ams" => TermDefinition.new("ams", id: "http://data.amadeus.com/", simple: true, prefix: true),
      ...
      "apb" => TermDefinition.new("apb", id: "http://www.analysispartners.org/businessmodel/", simple: true, prefix: true),
      ...
      "apods" => TermDefinition.new("apods", id: "http://activitypods.org/ns/core#", simple: true, prefix: true),
      ...
      "archivo" => TermDefinition.new("archivo", id: "https://archivo.dbpedia.org/onto#", simple: true, prefix: true),
      "arecipe" => TermDefinition.new("arecipe", id: "http://purl.org/amicroformat/arecipe/", simple: true, prefix: true),
      "arena" => TermDefinition.new("arena", id: "https://solid.ti.rw.fau.de/public/ns/arena#", simple: true, prefix: true),
      ...
      "asb" => TermDefinition.new("asb", id: "https://w3id.org/asbingowl/core#", simple: true, prefix: true),
      "aseonto" => TermDefinition.new("aseonto", id: "http://requirement.ase.ru/requirements_ontology#", simple: true, prefix: true),
      "asf" => TermDefinition.new("asf", id: "https://www.stm-assoc.org/asf/", simple: true, prefix: true),
      "asgs" => TermDefinition.new("asgs", id: "http://linked.data.gov.au/def/asgs#", simple: true, prefix: true),
      "asgv" => TermDefinition.new("asgv", id: "http://aims.fao.org/aos/agrovoc/", simple: true, prefix: true),
      "asio" => TermDefinition.new("asio", id: "http://purl.org/hercules/asio/core#", simple: true, prefix: true),
      "asn" => TermDefinition.new("asn", id: "http://purl.org/ASN/schema/core/", simple: true, prefix: true),
      "aspect" => TermDefinition.new("aspect", id: "http://purl.org/aspect/", simple: true, prefix: true),
      ...
      "atcc" => TermDefinition.new("atcc", id: "https://www.atcc.org/products/", simple: true, prefix: true),
      ...
      "bacnet" => TermDefinition.new("bacnet", id: "http://data.ashrae.org/bacnet/2020#", simple: true, prefix: true),
      "baf" => TermDefinition.new("baf", id: "https://w3id.org/baf#", simple: true, prefix: true),
      "bag" => TermDefinition.new("bag", id: "https://bag2.basisregistraties.overheid.nl/bag/def/", simple: true, prefix: true),
      "bag2" => TermDefinition.new("bag2", id: "http://bag.basisregistraties.overheid.nl/def/bag#", simple: true, prefix: true),
      "bao" => TermDefinition.new("bao", id: "http://www.bioassayontology.org/bao#", simple: true, prefix: true),
      "basic" => TermDefinition.new("basic", id: "http://def.seegrid.csiro.au/isotc211/iso19103/2005/basic#", simple: true, prefix: true),
      "batmanont" => TermDefinition.new("batmanont", id: "http://emmo.info/emmo/application/bmo#", simple: true, prefix: true),
      "bau" => TermDefinition.new("bau", id: "https://terminology.fraunhofer.de/voc/bau#", simple: true, prefix: true),
      ...
      "bdg" => TermDefinition.new("bdg", id: "http://data.bigdatagrapes.eu/resource/ontology/", simple: true, prefix: true),
      ...
      "bdsubj" => TermDefinition.new("bdsubj", id: "https://purl.org/fidbaudigital/subjects#", simple: true, prefix: true),
      ...
      "beo" => TermDefinition.new("beo", id: "http://pi.pauwel.be/voc/buildingelement#", simple: true, prefix: true),
      "besluit" => TermDefinition.new("besluit", id: "http://data.vlaanderen.be/ns/besluit#", simple: true, prefix: true),
      "besluitvor" => TermDefinition.new("besluitvor", id: "https://data.vlaanderen.be/ns/besluitvorming#", simple: true, prefix: true),
      ...
      "bgcat" => TermDefinition.new("bgcat", id: "http://bg.dbpedia.org/resource/Категория:", simple: true, prefix: true),
      ...
      "bgt" => TermDefinition.new("bgt", id: "https://bgt.basisregistraties.overheid.nl/bgt/def/", simple: true, prefix: true),
      "bib" => TermDefinition.new("bib", id: "http://zeitkunst.org/bibtex/0.1/bibtex.owl#", simple: true, prefix: true),
      "bibframe" => TermDefinition.new("bibframe", id: "http://id.loc.gov/ontologies/bibframe/", simple: true, prefix: true),
      ...
      "biocrm" => TermDefinition.new("biocrm", id: "http://ldf.fi/schema/bioc/", simple: true, prefix: true),
      "bioentity" => TermDefinition.new("bioentity", id: "http://bioentity.io/vocab/", simple: true, prefix: true),
      "biogrid" => TermDefinition.new("biogrid", id: "http://thebiogrid.org/", simple: true, prefix: true),
      "biol" => TermDefinition.new("biol", id: "http://purl.org/NET/biol/ns#", simple: true, prefix: true),
      "biolink" => TermDefinition.new("biolink", id: "https://w3id.org/biolink/vocab/", simple: true, prefix: true),
      ...
      "bioschemas" => TermDefinition.new("bioschemas", id: "https://bioschemas.org/", simple: true, prefix: true),
      ...
      "birthdate" => TermDefinition.new("birthdate", id: "http://schema.org/birthDate/", simple: true, prefix: true),
      "bis" => TermDefinition.new("bis", id: "http://bis.270a.info/dataset/", simple: true, prefix: true),
      "bitl" => TermDefinition.new("bitl", id: "http://lib.bit.edu.cn/ontology/1.0/", simple: true, prefix: true),
      ...
      "bldont" => TermDefinition.new("bldont", id: "http://ont.biglinkeddata.com/", simple: true, prefix: true),
      "ble" => TermDefinition.new("ble", id: "http://vocab.rapidthings.eu/ns/ble.ttl#", simple: true, prefix: true),
      "bleadapter" => TermDefinition.new("bleadapter", id: "http://vocab.rapidthings.eu/ns/ble/adapter.ttl#", simple: true, prefix: true),
      ...
      "bmp" => TermDefinition.new("bmp", id: "http://w3id.org/bmp#", simple: true, prefix: true),
      ...
      "bp3" => TermDefinition.new("bp3", id: "http://www.biopax.org/release/biopax-level3.owl#", simple: true, prefix: true),
      ...
      "brick" => TermDefinition.new("brick", id: "https://brickschema.org/schema/Brick#", simple: true, prefix: true),
      ...
      "brot" => TermDefinition.new("brot", id: "https://w3id.org/brot#", simple: true, prefix: true),
      "brt" => TermDefinition.new("brt", id: "http://brt.basisregistraties.overheid.nl/def/top10nl#", simple: true, prefix: true),
      "bs" => TermDefinition.new("bs", id: "https://w3id.org/def/basicsemantics-owl#", simple: true, prefix: true),
      ...
      "bsdd" => TermDefinition.new("bsdd", id: "http://bsdd.buildingsmart.org/def#", simple: true, prefix: true),
      "bsh" => TermDefinition.new("bsh", id: "https://brickschema.org/schema/1.1.0/BrickShape#", simple: true, prefix: true),
      ...
      "bto" => TermDefinition.new("bto", id: "http://emmo.info/emmo/application/bto#", simple: true, prefix: true),
      ...
      "capes" => TermDefinition.new("capes", id: "http://vocab.capes.gov.br/def/vcav#", simple: true, prefix: true),
      ...
      "cbb" => TermDefinition.new("cbb", id: "https://data.cbb.omgeving.vlaanderen.be/ns/cbb#", simple: true, prefix: true),
      ...
      "cdc" => TermDefinition.new("cdc", id: "https://w3id.org/cdc#", simple: true, prefix: true),
      "cdm" => TermDefinition.new("cdm", id: "http://publications.europa.eu/ontology/cdm#", simple: true, prefix: true),
      "cdt" => TermDefinition.new("cdt", id: "https://w3id.org/cdt/", simple: true, prefix: true),
      ...
      "ceo" => TermDefinition.new("ceo", id: "https://linkeddata.cultureelerfgoed.nl/def/ceo#", simple: true, prefix: true),
      "ceosp" => TermDefinition.new("ceosp", id: "https://linkeddata.cultureelerfgoed.nl/def/ceosp/", simple: true, prefix: true),
      "ceox" => TermDefinition.new("ceox", id: "https://linkeddata.cultureelerfgoed.nl/def/ceox#", simple: true, prefix: true),
      "cercabib" => TermDefinition.new("cercabib", id: "https://cercabib.ub.edu/", simple: true, prefix: true),
      "cerealstoo" => TermDefinition.new("cerealstoo", id: "http://rdf.ag/o/cerealstoo#", simple: true, prefix: true),
      "cergy" => TermDefinition.new("cergy", id: "https://dbpedia.org/page/Cergy/", simple: true, prefix: true),
      ...
      "cex" => TermDefinition.new("cex", id: "http://purl.org/weso/ontology/computex#", simple: true, prefix: true),
      ...
      "cgo" => TermDefinition.new("cgo", id: "https://www.tno.nl/agrifood/ontology/common-greenhouse-ontology#", simple: true, prefix: true),
      "cgov" => TermDefinition.new("cgov", id: "http://reference.data.gov.uk/def/central-government/", simple: true, prefix: true),
      "ch" => TermDefinition.new("ch", id: "https://schema.ld.admin.ch/", simple: true, prefix: true),
      "chameo" => TermDefinition.new("chameo", id: "http://emmo.info/emmo/domain/chameo/chameo#", simple: true, prefix: true),
      ...
      "chebi" => TermDefinition.new("chebi", id: "http://purl.obolibrary.org/obo/CHEBI_", simple: true),
      ...
      "chemrof" => TermDefinition.new("chemrof", id: "https://w3id.org/chemrof/", simple: true, prefix: true),
      "chemsci" => TermDefinition.new("chemsci", id: "https://w3id.org/skgo/chemsci#", simple: true, prefix: true),
      "chess" => TermDefinition.new("chess", id: "http://purl.org/NET/rdfchess/ontology/", simple: true, prefix: true),
      "chord" => TermDefinition.new("chord", id: "http://purl.org/ontology/chord/", simple: true, prefix: true),
      "chpaf" => TermDefinition.new("chpaf", id: "https://ch.paf.link/", simple: true, prefix: true),
      "ci" => TermDefinition.new("ci", id: "https://privatealpha.com/ontology/content-inventory/1#", simple: true, prefix: true),
      "ciao" => TermDefinition.new("ciao", id: "http://ciao.it/", simple: true, prefix: true),
      "cido" => TermDefinition.new("cido", id: "http://purl.obolibrary.org/obo/cido.owl/", simple: true, prefix: true),
      ...
      "coda" => TermDefinition.new("coda", id: "http://art.uniroma2.it/coda/contracts/", simple: true, prefix: true),
      ...
      "compub" => TermDefinition.new("compub", id: "https://sireneld.io/vocab/compub#", simple: true, prefix: true),
      ...
      "conllu" => TermDefinition.new("conllu", id: "https://universaldependencies.org/format.html#", simple: true, prefix: true),
      ...
      "consolid" => TermDefinition.new("consolid", id: "https://w3id.org/consolid#", simple: true, prefix: true),
      ...
      "contax" => TermDefinition.new("contax", id: "https://w3id.org/con-tax#", simple: true, prefix: true),
      "content" => TermDefinition.new("content", id: "http://purl.org/rss/1.0/modules/content/", simple: true, prefix: true),
      "contry" => TermDefinition.new("contry", id: "http://dbpedia.org/resource/Lyon#", simple: true, prefix: true),
      ...
      "coos" => TermDefinition.new("coos", id: "http://id.unece.org/def/coos#", simple: true, prefix: true),
      ...
      "coreo" => TermDefinition.new("coreo", id: "http://purl.org/coreo#", simple: true, prefix: true),
      ...
      "country" => TermDefinition.new("country", id: "http://eulersharp.sourceforge.net/2003/03swap/countries#", simple: true, prefix: true),
      ...
      "covido" => TermDefinition.new("covido", id: "https://w3id.org/CovidO#", simple: true, prefix: true),
      "coy" => TermDefinition.new("coy", id: "https://schema.coypu.org/global#", simple: true, prefix: true),
      "cp" => TermDefinition.new("cp", id: "http://schemas.openxmlformats.org/package/2006/metadata/core-properties/", simple: true, prefix: true),
      ...
      "cpc" => TermDefinition.new("cpc", id: "https://data.epo.org/linked-data/def/cpc/", simple: true, prefix: true),
      ...
      "cpsvno" => TermDefinition.new("cpsvno", id: "http://data.norge.no/vocabulary/cpsvno#", simple: true, prefix: true),
      ...
      "crmsci" => TermDefinition.new("crmsci", id: "http://cidoc-crm.org/crmsci/", simple: true, prefix: true),
      ...
      "cso" => TermDefinition.new("cso", id: "http://cso.kmi.open.ac.uk/schema/cso/", simple: true, prefix: true),
      ...
      "cto" => TermDefinition.new("cto", id: "https://w3id.org/cto#", simple: true, prefix: true),
      ...
      "cts" => TermDefinition.new("cts", id: "http://rdf.cdisc.org/ct/schema#", simple: true, prefix: true),
      ...
      "cube" => TermDefinition.new("cube", id: "https://cube.link/", simple: true, prefix: true),
      ...
      "cur" => TermDefinition.new("cur", id: "http://qudt.org/2.1/vocab/currency/", simple: true, prefix: true),
      ...
      "cvb" => TermDefinition.new("cvb", id: "http://rdfs.org/resume-rdf/base.rdfs#", simple: true, prefix: true),
      ...
      "databus" => TermDefinition.new("databus", id: "https://dataid.dbpedia.org/databus#", simple: true, prefix: true),
      ...
      "datagc" => TermDefinition.new("datagc", id: "https://data.grottocenter.org/ldp/", simple: true, prefix: true),
      ...
      "dbd" => TermDefinition.new("dbd", id: "http://dbpedia.org/datatype/", simple: true, prefix: true),
      ...
      "dbonto" => TermDefinition.new("dbonto", id: "http://dbepedia.org/ontology/", simple: true, prefix: true),
      ...
      "dbpediaowl" => TermDefinition.new("dbpediaowl", id: "http://dbpedia.org/owl/", simple: true, prefix: true),
      "dbpg" => TermDefinition.new("dbpg", id: "http://dbpedia.org/page/", simple: true, prefix: true),
      ...
      "dcatap" => TermDefinition.new("dcatap", id: "http://data.europa.eu/r5r/", simple: true, prefix: true),
      ...
      "dcatno" => TermDefinition.new("dcatno", id: "https://data.norge.no/vocabulary/dcatno#", simple: true, prefix: true),
      "dcb" => TermDefinition.new("dcb", id: "http://dbpedia.org/resource/Category:", simple: true, prefix: true),
      ...
      "dcm" => TermDefinition.new("dcm", id: "http://purl.org/dc/dcmitype/", simple: true, prefix: true),
      ...
      "dd" => TermDefinition.new("dd", id: "http://example.org/dummydata/", simple: true, prefix: true),
      ...
      "dde" => TermDefinition.new("dde", id: "https://www.ddeworld.org/", simple: true, prefix: true),
      ...
      "dentsci" => TermDefinition.new("dentsci", id: "https://w3id.org/skgo/dentsci#", simple: true, prefix: true),
      "deo" => TermDefinition.new("deo", id: "http://purl.org/spar/deo/", simple: true, prefix: true),
      "deonta" => TermDefinition.new("deonta", id: "https://deonta.linkedmodel.org/deonta/", simple: true, prefix: true),
      ...
      "dick" => TermDefinition.new("dick", id: "http://pornhub.com/", simple: true, prefix: true),
      ...
      "diso" => TermDefinition.new("diso", id: "https://purls.helmholtz-metadaten.de/diso#", simple: true, prefix: true),
      ...
      "djo" => TermDefinition.new("djo", id: "http://purl.org/datajourneys/", simple: true, prefix: true),
      ...
      "dm" => TermDefinition.new("dm", id: "http://datamusee.givingsense.eu/onto/", simple: true, prefix: true),
      "dm2e" => TermDefinition.new("dm2e", id: "http://onto.dm2e.eu/schemas/dm2e/", simple: true, prefix: true),
      "dmo" => TermDefinition.new("dmo", id: "https://w3id.org/dmo#", simple: true, prefix: true),
      "dmp" => TermDefinition.new("dmp", id: "http://www.sysresearch.org/rda-common-dmp#", simple: true, prefix: true),
      ...
      "doam" => TermDefinition.new("doam", id: "http://emmo.info/doam#", simple: true, prefix: true),
      ...
      "docam" => TermDefinition.new("docam", id: "https://www.docam.ca/glossaurus/", simple: true, prefix: true),
      "docbook" => TermDefinition.new("docbook", id: "http://docbook.org/ns/docbook/", simple: true, prefix: true),
      "doce" => TermDefinition.new("doce", id: "http://purl.org/nemo/doce#", simple: true, prefix: true),
      ...
      "dqvno" => TermDefinition.new("dqvno", id: "https://data.norge.no/vocabulary/dqvno#", simple: true, prefix: true),
      ...
      "dsd" => TermDefinition.new("dsd", id: "https://w3id.org/dsd#", simple: true, prefix: true),
      "dsfv" => TermDefinition.new("dsfv", id: "http://sws.ifi.uio.no/vocab/dsf/henriwi/dsf#", simple: true, prefix: true),
      "dsi" => TermDefinition.new("dsi", id: "https://data.dsi.omgeving.vlaanderen.be/ns/dsi#", simple: true, prefix: true),
      ...
      "eb" => TermDefinition.new("eb", id: "https://w3id.org/eb#", simple: true, prefix: true),
      "ebg" => TermDefinition.new("ebg", id: "http://data.businessgraph.io/ontology#", simple: true, prefix: true),
      ...
      "eccf" => TermDefinition.new("eccf", id: "http://data.europa.eu/54i/", simple: true, prefix: true),
      ...
      "ecfo" => TermDefinition.new("ecfo", id: "https://w3id.org/ecfo#", simple: true, prefix: true),
      ...
      "ecos" => TermDefinition.new("ecos", id: "http://purl.org/ecos#", simple: true, prefix: true),
      ...
      "eep" => TermDefinition.new("eep", id: "https://w3id.org/eep#", simple: true, prefix: true),
      ...
      "eg" => TermDefinition.new("eg", id: "http://www.example.org/", simple: true, prefix: true),
      "egdo" => TermDefinition.new("egdo", id: "http://example.org/", simple: true, prefix: true),
      ...
      "emmo" => TermDefinition.new("emmo", id: "http://emmo.info/emmo#", simple: true, prefix: true),
      ...
      "epo" => TermDefinition.new("epo", id: "http://data.europa.eu/a4g/ontology#", simple: true, prefix: true),
      ...
      "eproc2" => TermDefinition.new("eproc2", id: "http://10.0.3.120/download/eproc_FORN_v04.owl#", simple: true, prefix: true),
      "eqp" => TermDefinition.new("eqp", id: "https://data.nasa.gov/ontologies/atmonto/equipment#", simple: true, prefix: true),
      "era" => TermDefinition.new("era", id: "http://data.europa.eu/949/", simple: true, prefix: true),
      ...
      "esagen" => TermDefinition.new("esagen", id: "http://vocab.ciudadesabiertas.es/def/sector-publico/agenda-municipal#", simple: true, prefix: true),
      "esagm" => TermDefinition.new("esagm", id: "http://vocab.ciudadesabiertas.es/def/sector-publico/agenda-municipal#", simple: true, prefix: true),
      ...
      "esautob" => TermDefinition.new("esautob", id: "http://vocab.ciudadesabiertas.es/def/transporte/autobus#", simple: true, prefix: true),
      "esbici" => TermDefinition.new("esbici", id: "http://vocab.ciudadesabiertas.es/def/transporte/bicicleta-publica#", simple: true, prefix: true),
      "esc" => TermDefinition.new("esc", id: "https://solid.ti.rw.fau.de/public/ns/event-sourcing-containers#", simple: true, prefix: true),
      ...
      "esconv" => TermDefinition.new("esconv", id: "http://vocab.ciudadesabiertas.es/def/sector-publico/convenio#", simple: true, prefix: true),
      ...
      "esdir" => TermDefinition.new("esdir", id: "http://vocab.linkeddata.es/datosabiertos/def/urbanismo-infraestructuras/direccion-postal#", simple: true, prefix: true),
      "eseduc" => TermDefinition.new("eseduc", id: "http://www.purl.org/ontologia/eseduc#", simple: true, prefix: true),
      "esempleo" => TermDefinition.new("esempleo", id: "http://vocab.ciudadesabiertas.es/def/sector-publico/empleo#", simple: true, prefix: true),
      ...
      "esgs" => TermDefinition.new("esgs", id: "https://w3id.org/edwin/ontology/", simple: true, prefix: true),
      ...
      "estraf" => TermDefinition.new("estraf", id: "http://vocab.ciudadesabiertas.es/def/transporte/trafico#", simple: true, prefix: true),
      ...
      "eurio" => TermDefinition.new("eurio", id: "http://data.europa.eu/s66#", simple: true, prefix: true),
      ...
      "eurovoc" => TermDefinition.new("eurovoc", id: "http://eurovoc.europa.eu/", simple: true, prefix: true),
      ...
      "exekg" => TermDefinition.new("exekg", id: "https://raw.githubusercontent.com/nsai-uio/ExeKGOntology/main/ds_exeKGOntology.ttl#", simple: true, prefix: true),
      ...
      "experts" => TermDefinition.new("experts", id: "http://emmo.info/emmo/application/maeo/experts#", simple: true, prefix: true),
      "express" => TermDefinition.new("express", id: "https://w3id.org/express#", simple: true, prefix: true),
      "ext" => TermDefinition.new("ext", id: "http://mu.semte.ch/vocabularies/ext/", simple: true, prefix: true),
      ...
      "fdof" => TermDefinition.new("fdof", id: "https://w3id.org/fdof/ontology#", simple: true, prefix: true),
      "fdp" => TermDefinition.new("fdp", id: "https://w3id.org/fdp/fdp-o#", simple: true, prefix: true),
      ...
      "feed" => TermDefinition.new("feed", id: "https://www.feedipedia.org/", simple: true, prefix: true),
      "fel" => TermDefinition.new("fel", id: "http://w3id.org/vcb/fel#", simple: true, prefix: true),
      "fernanda" => TermDefinition.new("fernanda", id: "http://fernanda.nl/", simple: true, prefix: true),
      "fhir" => TermDefinition.new("fhir", id: "http://hl7.org/fhir/", simple: true, prefix: true),
      "fibo" => TermDefinition.new("fibo", id: "https://spec.edmcouncil.org/fibo/ontology/master/latest/", simple: true, prefix: true),
      "figigii" => TermDefinition.new("figigii", id: "http://www.omg.org/spec/FIGI/GlobalInstrumentIdentifiers/", simple: true, prefix: true),
      "film" => TermDefinition.new("film", id: "http://semantics.id/ns/example/film/", simple: true, prefix: true),
      ...
      "fisa" => TermDefinition.new("fisa", id: "https://ifitkau.github.io/fisa/", simple: true, prefix: true),
      ...
      "fno" => TermDefinition.new("fno", id: "https://w3id.org/function/ontology#", simple: true, prefix: true),
      ...
      "fpr" => TermDefinition.new("fpr", id: "http://www.filmstandards.org/schemas/filmportal_relations#", simple: true, prefix: true),
      ...
      "freq" => TermDefinition.new("freq", id: "http://purl.org/cld/freq/", simple: true, prefix: true),
      ...
      "fs" => TermDefinition.new("fs", id: "https://www.compliancequest.com/training-management-software-system-solutions/", simple: true, prefix: true),
      "fso" => TermDefinition.new("fso", id: "https://w3id.org/fso#", simple: true, prefix: true),
      ...
      "gco" => TermDefinition.new("gco", id: "http://purl.jp/bio/12/glyco/conjugate#", simple: true, prefix: true),
      ...
      "generiek" => TermDefinition.new("generiek", id: "https://data.vlaanderen.be/ns/generiek#", simple: true, prefix: true),
      ...
      "gist" => TermDefinition.new("gist", id: "https://ontologies.semanticarts.com/o/gistCore#", simple: true, prefix: true),
      ...
      "gleio" => TermDefinition.new("gleio", id: "http://lei.info/gleio/", simple: true, prefix: true),
      ...
      "gmo" => TermDefinition.new("gmo", id: "http://purl.jp/bio/10/gmo/", simple: true, prefix: true),
      "gn" => TermDefinition.new("gn", id: "http://www.geonames.org/ontology#", simple: true, prefix: true),
      "gnaf" => TermDefinition.new("gnaf", id: "http://linked.data.gov.au/def/gnaf#", simple: true, prefix: true),
      ...
      "go" => TermDefinition.new("go", id: "http://purl.obolibrary.org/obo/GO_", simple: true),
      "goaf" => TermDefinition.new("goaf", id: "http://goaf.fr/goaf#", simple: true, prefix: true),
      "goavoc" => TermDefinition.new("goavoc", id: "http://bio2rdf.org/goa_vocabulary:", simple: true, prefix: true),
      ...
      "godaddy" => TermDefinition.new("godaddy", id: "https://sso.godaddy.com/", simple: true, prefix: true),
      ...
      "gql" => TermDefinition.new("gql", id: "http://www.openlinksw.com/schemas/graphql#", simple: true, prefix: true),
      ...
      "grel" => TermDefinition.new("grel", id: "http://users.ugent.be/~bjdmeest/function/grel.ttl#", simple: true, prefix: true),
      ...
      "grscicoll" => TermDefinition.new("grscicoll", id: "https://www.gbif.org/grscicoll/collection/", simple: true, prefix: true),
      "gs1" => TermDefinition.new("gs1", id: "https://gs1.org/voc/", simple: true, prefix: true),
      ...
      "guez" => TermDefinition.new("guez", id: "http://guez.fr/", simple: true, prefix: true),
      ...
      "gx" => TermDefinition.new("gx", id: "https://graphite.synaptica.net/extension/", simple: true, prefix: true),
      ...
      "hctl" => TermDefinition.new("hctl", id: "https://www.w3.org/2019/wot/hypermedia#", simple: true, prefix: true),
      "hdgi" => TermDefinition.new("hdgi", id: "https://w3id.org/hdgi#", simple: true, prefix: true),
      ...
      "hmas" => TermDefinition.new("hmas", id: "https://purl.org/hmas/", simple: true, prefix: true),
      "hni" => TermDefinition.new("hni", id: "https://collectiedata.hetnieuweinstituut.nl/", simple: true, prefix: true),
      "hola" => TermDefinition.new("hola", id: "https://moodle.insa-lyon.fr/course/view.php?id=", simple: true),
      "holding" => TermDefinition.new("holding", id: "http://purl.org/ontology/holding#", simple: true, prefix: true),
      "hops" => TermDefinition.new("hops", id: "https://rdf.ag/o/hops#", simple: true, prefix: true),
      ...
      "hpo" => TermDefinition.new("hpo", id: "http://emmo.info/emmo/application/hpo#", simple: true, prefix: true),
      "hpont" => TermDefinition.new("hpont", id: "https://w3id.org/hpont#", simple: true, prefix: true),
      "hqdm" => TermDefinition.new("hqdm", id: "http://www.semanticweb.org/hqdm#", simple: true, prefix: true),
      "hqdmontol" => TermDefinition.new("hqdmontol", id: "http://www.semanticweb.org/magma-core/ontologies/hqdm#", simple: true, prefix: true),
      ...
      "html" => TermDefinition.new("html", id: "http://www.w3.org/1999/xhtml/", simple: true, prefix: true),
      ...
      "htv" => TermDefinition.new("htv", id: "http://www.w3.org/2011/http#", simple: true, prefix: true),
      "hu" => TermDefinition.new("hu", id: "https://mail.google.com/", simple: true, prefix: true),
      ...
      "hy" => TermDefinition.new("hy", id: "https://api.hyprdia.com/", simple: true, prefix: true),
      "hydra" => TermDefinition.new("hydra", id: "http://www.w3.org/ns/hydra/core#", simple: true, prefix: true),
      "hyr" => TermDefinition.new("hyr", id: "https://w3id.org/simulation/data/", simple: true, prefix: true),
      "i18n" => TermDefinition.new("i18n", id: "https://www.w3.org/ns/i18n#", simple: true, prefix: true),
      "iab" => TermDefinition.new("iab", id: "https://www.iab.com/guidelines/taxonomy/", simple: true, prefix: true),
      "iaco" => TermDefinition.new("iaco", id: "https://iaco.me/", simple: true, prefix: true),
      "iana" => TermDefinition.new("iana", id: "http://www.iana.org/assignments/relation/", simple: true, prefix: true),
      "ianarel" => TermDefinition.new("ianarel", id: "https://www.w3.org/ns/iana/link-relations/relation#", simple: true, prefix: true),
      "iao" => TermDefinition.new("iao", id: "http://purl.obolibrary.org/obo/IAO_", simple: true),
      "iaph" => TermDefinition.new("iaph", id: "http://www.juntadeandalucia.es/datosabiertos/portal/iaph/dataset/dataset/6c199ca2-8d2e-4c12-833c-f28", simple: true),
      "iati" => TermDefinition.new("iati", id: "http://purl.org/collections/iati/", simple: true, prefix: true),
      "ibeacon" => TermDefinition.new("ibeacon", id: "http://vocab.rapidthings.eu/ns/apple/ibeacon.ttl#", simple: true, prefix: true),
      ...
      "icon" => TermDefinition.new("icon", id: "https://w3id.org/icon/ontology/", simple: true, prefix: true),
      "id" => TermDefinition.new("id", id: "http://identifiers.org/", simple: true, prefix: true),
      "iddo" => TermDefinition.new("iddo", id: "https://w3id.org/iddo#", simple: true, prefix: true),
      ...
      "ies" => TermDefinition.new("ies", id: "http://ies.data.gov.uk/ontology/ies4#", simple: true, prefix: true),
      "ies4" => TermDefinition.new("ies4", id: "http://ies.data.gov.uk/ontology/ies4#", simple: true, prefix: true),
      ...
      "iig" => TermDefinition.new("iig", id: "https://w3id.org/iicongraph/data/", simple: true, prefix: true),
      ...
      "imbor" => TermDefinition.new("imbor", id: "https://data.crow.nl/imbor/def/", simple: true, prefix: true),
      ...
      "inchikey" => TermDefinition.new("inchikey", id: "https://identifiers.org/inchikey:", simple: true, prefix: true),
      "incident" => TermDefinition.new("incident", id: "http://vocab.resc.info/incident#", simple: true, prefix: true),
      "ind" => TermDefinition.new("ind", id: "https://w3id.org/inesdata#", simple: true, prefix: true),
      ...
      "into" => TermDefinition.new("into", id: "https://www.apluss.de/ontology/into#", simple: true, prefix: true),
      "io" => TermDefinition.new("io", id: "https://iaco.me/", simple: true, prefix: true),
      "ioc" => TermDefinition.new("ioc", id: "http://w3id.org/ioc#", simple: true, prefix: true),
      "iol" => TermDefinition.new("iol", id: "http://www.ontologydesignpatterns.org/ont/dul/IOLite.owl#", simple: true, prefix: true),
      "iop" => TermDefinition.new("iop", id: "https://w3id.org/iadopt/ont/", simple: true, prefix: true),
      "iospress" => TermDefinition.new("iospress", id: "http://ld.iospress.nl/rdf/ontology/", simple: true, prefix: true),
      "iot" => TermDefinition.new("iot", id: "http://iotschema.org/", simple: true, prefix: true),
      ...
      "iottta" => TermDefinition.new("iottta", id: "https://w3id.org/iot-tta#", simple: true, prefix: true),
      ...
      "itcrdf" => TermDefinition.new("itcrdf", id: "http://www.w3.org/2005/11/its/rdf#", simple: true, prefix: true),
      ...
      "itops" => TermDefinition.new("itops", id: "https://vocab.eccenca.com/itops/", simple: true, prefix: true),
      ...
      "jsonschema" => TermDefinition.new("jsonschema", id: "https://www.w3.org/2019/wot/json-schema#", simple: true, prefix: true),
      "jup" => TermDefinition.new("jup", id: "http://w3id.org/charta77/jup/", simple: true, prefix: true),
      "jur" => TermDefinition.new("jur", id: "http://sweet.jpl.nasa.gov/2.3/humanJurisdiction.owl#", simple: true, prefix: true),
      ...
      "karstlink" => TermDefinition.new("karstlink", id: "https://ontology.uis-speleo.org/ontology/#", simple: true, prefix: true),
      ...
      "kdsf" => TermDefinition.new("kdsf", id: "https://kerndatensatz-forschung.de/version1/technisches_datenmodell/owl/kdsf.owl#", simple: true, prefix: true),
      ...
      "keyon" => TermDefinition.new("keyon", id: "http://keyelements.ltd/ontologies/keyon/#", simple: true, prefix: true),
      "keys" => TermDefinition.new("keys", id: "http://purl.org/NET/c4dm/keys.owl#", simple: true, prefix: true),
      "kgi" => TermDefinition.new("kgi", id: "http://ns.inria.fr/kg/index#", simple: true, prefix: true),
      "kko" => TermDefinition.new("kko", id: "http://kbpedia.org/kko/rc/", simple: true, prefix: true),
      ...
      "koko" => TermDefinition.new("koko", id: "https://seznam.cz/", simple: true, prefix: true),
      "kokot" => TermDefinition.new("kokot", id: "http://www.koko.t/", simple: true, prefix: true),
      ...
      "ksamsok" => TermDefinition.new("ksamsok", id: "http://kulturarvsdata.se/ksamsok#", simple: true, prefix: true),
      ...
      "lado" => TermDefinition.new("lado", id: "http://archaeology.link/ontology#", simple: true, prefix: true),
      ...
      "latitude" => TermDefinition.new("latitude", id: "https://www.w3.org/2006/vcard/ns#", simple: true, prefix: true),
      "lawd" => TermDefinition.new("lawd", id: "http://lawd.info/ontology/", simple: true, prefix: true),
      "lbds" => TermDefinition.new("lbds", id: "https://w3id.org/lbdserver#", simple: true, prefix: true),
      "lbdserver" => TermDefinition.new("lbdserver", id: "https://w3id.org/lbdserver#", simple: true, prefix: true),
      ...
      "lcnaf" => TermDefinition.new("lcnaf", id: "http://id.loc.gov/authorities/names/", simple: true, prefix: true),
      ...
      "ld" => TermDefinition.new("ld", id: "http://linkeddata.ru/", simple: true, prefix: true),
      ...
      "ldes" => TermDefinition.new("ldes", id: "https://w3id.org/ldes#", simple: true, prefix: true),
      ...
      "ldpsc" => TermDefinition.new("ldpsc", id: "https://solid.ti.rw.fau.de/public/ns/stream-containers#", simple: true, prefix: true),
      ...
      "lds" => TermDefinition.new("lds", id: "https://solid.ti.rw.fau.de/public/ns/linked-data-structures#", simple: true, prefix: true),
      ...
      "leaks" => TermDefinition.new("leaks", id: "https://onlyfans.com/chelxie/", simple: true, prefix: true),
      ...
      "lesa" => TermDefinition.new("lesa", id: "http://hadatac.org/ont/lesa#", simple: true, prefix: true),
      ...
      "lexicog" => TermDefinition.new("lexicog", id: "http://www.w3.org/ns/lemon/lexicog#", simple: true, prefix: true),
      "lexicon" => TermDefinition.new("lexicon", id: "http://www.example.org/lexicon#", simple: true, prefix: true),
      "lexinfo" => TermDefinition.new("lexinfo", id: "http://www.lexinfo.net/ontology/3.0/lexinfo#", simple: true, prefix: true),
      ...
      "link" => TermDefinition.new("link", id: "http://www.w3.org/2007/ont/link#", simple: true, prefix: true),
      "linkedart" => TermDefinition.new("linkedart", id: "https://linked.art/ns/terms/", simple: true, prefix: true),
      "linkedct" => TermDefinition.new("linkedct", id: "http://data.linkedct.org/vocab/", simple: true, prefix: true),
      "linkedmdb" => TermDefinition.new("linkedmdb", id: "http://data.linkedmdb.org/", simple: true, prefix: true),
      "linkml" => TermDefinition.new("linkml", id: "https://w3id.org/linkml/", simple: true, prefix: true),
      ...
      "lmdb" => TermDefinition.new("lmdb", id: "http://data.linkedmdb.org/", simple: true, prefix: true),
      ...
      "loci" => TermDefinition.new("loci", id: "http://linked.data.gov.au/def/loci#", simple: true, prefix: true),
      ...
      "loinc" => TermDefinition.new("loinc", id: "https://loinc.org/", simple: true, prefix: true),
      "lol" => TermDefinition.new("lol", id: "https://sbalot.github.io/lol/", simple: true, prefix: true),
      ...
      "lpwc" => TermDefinition.new("lpwc", id: "https://linkedpaperswithcode.com/property/", simple: true, prefix: true),
      "lr" => TermDefinition.new("lr", id: "http://linkedrecipes.org/schema/", simple: true, prefix: true),
      "lrcommon" => TermDefinition.new("lrcommon", id: "http://landregistry.data.gov.uk/def/common/", simple: true, prefix: true),
      ...
      "m4i" => TermDefinition.new("m4i", id: "http://w3id.org/nfdi4ing/metadata4ing#", simple: true, prefix: true),
      ...
      "maeo" => TermDefinition.new("maeo", id: "http://emmo.info/emmo/application/maeo/experts#", simple: true, prefix: true),
      "maet" => TermDefinition.new("maet", id: "http://edg.topbraid.solutions/taxonomy/macroeconomics/", simple: true, prefix: true),
      "mag" => TermDefinition.new("mag", id: "https://makg.org/property/", simple: true, prefix: true),
      "magmardl" => TermDefinition.new("magmardl", id: "http://www.semanticweb.org/magma-core/rdl#", simple: true, prefix: true),
      "magmauser" => TermDefinition.new("magmauser", id: "http://www.semanticweb.org/magma-core/user#", simple: true, prefix: true),
      "malaka" => TermDefinition.new("malaka", id: "http://george.gr/", simple: true, prefix: true),
      ...
      "manto" => TermDefinition.new("manto", id: "http://com.vortic3.MANTO/", simple: true, prefix: true),
      "marc" => TermDefinition.new("marc", id: "http://www.loc.gov/MARC21/slim/", simple: true, prefix: true),
      "marcgt" => TermDefinition.new("marcgt", id: "https://id.loc.gov/vocabulary/marcgt/", simple: true, prefix: true),
      ...
      "maroc" => TermDefinition.new("maroc", id: "http://fr.dbpedia.org/page/Maroc/", simple: true, prefix: true),
      ...
      "matmine" => TermDefinition.new("matmine", id: "http://materialsmine.org/ns/", simple: true, prefix: true),
      ...
      "mbkeys" => TermDefinition.new("mbkeys", id: "https://pastebin.com/ThBfphb8#", simple: true, prefix: true),
      "mccv" => TermDefinition.new("mccv", id: "http://purl.jp/bio/10/mccv#", simple: true, prefix: true),
      "md" => TermDefinition.new("md", id: "http://www.w3.org/ns/md#", simple: true, prefix: true),
      "mdcs" => TermDefinition.new("mdcs", id: "https://mdcs.monumentenkennis.nl/damageatlas/ontology#", simple: true, prefix: true),
      ...
      "melding" => TermDefinition.new("melding", id: "http://lblod.data.gift/vocabularies/automatische-melding/", simple: true, prefix: true),
      ...
      "memorix" => TermDefinition.new("memorix", id: "http://memorix.io/ontology#", simple: true, prefix: true),
      ...
      "meta" => TermDefinition.new("meta", id: "https://krr.triply.cc/krr/sameas-meta/def/", simple: true, prefix: true),
      ...
      "mgv" => TermDefinition.new("mgv", id: "http://mangaview.fr/mgv#", simple: true, prefix: true),
      "mi" => TermDefinition.new("mi", id: "http://www.marineinfo.org/ns/ontology#", simple: true, prefix: true),
      "mibc" => TermDefinition.new("mibc", id: "http://marineinfo.org/ns/library/bibcodes#", simple: true, prefix: true),
      "mibt" => TermDefinition.new("mibt", id: "https://marineinfo.org/ns/library/bibtypes#", simple: true, prefix: true),
      "mico" => TermDefinition.new("mico", id: "http://www.mico-project.eu/ns/platform/1.0/schema#", simple: true, prefix: true),
      "mifesto" => TermDefinition.new("mifesto", id: "https://w3id.org/mifesto#", simple: true, prefix: true),
      ...
      "mindat" => TermDefinition.new("mindat", id: "https://www.mindat.org/", simple: true, prefix: true),
      "minim" => TermDefinition.new("minim", id: "http://purl.org/minim/minim#", simple: true, prefix: true),
      "miprog" => TermDefinition.new("miprog", id: "https://marineinfo.org/ns/progress#", simple: true, prefix: true),
      "mir" => TermDefinition.new("mir", id: "http://marineinfo.org/ns/person/roles#", simple: true, prefix: true),
      ...
      "mltd" => TermDefinition.new("mltd", id: "https://mltd.pikopikopla.net/mltd-schema#", simple: true, prefix: true),
      ...
      "mmms" => TermDefinition.new("mmms", id: "http://ldf.fi/schema/mmm/", simple: true, prefix: true),
      ...
      "mnx" => TermDefinition.new("mnx", id: "https://rdf.metanetx.org/schema/", simple: true, prefix: true),
      ...
      "mobiliteit" => TermDefinition.new("mobiliteit", id: "https://data.vlaanderen.be/ns/mobiliteit#", simple: true, prefix: true),
      ...
      "mondo" => TermDefinition.new("mondo", id: "http://purl.obolibrary.org/obo/", simple: true, prefix: true),
      ...
      "motogp" => TermDefinition.new("motogp", id: "http://www.motogp.com/", simple: true, prefix: true),
      "movie" => TermDefinition.new("movie", id: "http://data.linkedmdb.org/resource/movie/", simple: true, prefix: true),
      "movieo" => TermDefinition.new("movieo", id: "http://movie.com/ontology/", simple: true, prefix: true),
      ...
      "nalt" => TermDefinition.new("nalt", id: "https://lod.nal.usda.gov/nalt/", simple: true, prefix: true),
      ...
      "nbo" => TermDefinition.new("nbo", id: "http://data.bioontology.org/ontologies/NBO/", simple: true, prefix: true),
      "ncal" => TermDefinition.new("ncal", id: "http://www.semanticdesktop.org/ontologies/2007/04/02/ncal#", simple: true, prefix: true),
      "ncbi" => TermDefinition.new("ncbi", id: "https://www.ncbi.nlm.nih.gov/", simple: true, prefix: true),
      ...
      "ncit" => TermDefinition.new("ncit", id: "https://ncit.nci.nih.gov/ncitbrowser/ConceptReport.jsp?dictionary=NCI_Thesaurus&ns=ncit&code=", simple: true),
      ...
      "nen2660" => TermDefinition.new("nen2660", id: "https://w3id.org/nen2660/def#", simple: true, prefix: true),
      ...
      "nom" => TermDefinition.new("nom", id: "https://nomenclature.info/nom/", simple: true, prefix: true),
      "nomo" => TermDefinition.new("nomo", id: "https://nomenclature.info/nom/ontology/", simple: true, prefix: true),
      "nosql" => TermDefinition.new("nosql", id: "http://purl.org/db/nosql#", simple: true, prefix: true),
      "notify" => TermDefinition.new("notify", id: "http://www.w3.org/ns/solid/notifications#", simple: true, prefix: true),
      ...
      "ntp" => TermDefinition.new("ntp", id: "https://schema.finto.fi/ntp#", simple: true, prefix: true),
      ...
      "nutscode" => TermDefinition.new("nutscode", id: "http://data.europa.eu/nuts/code/", simple: true, prefix: true),
      ...
      "oac" => TermDefinition.new("oac", id: "https://w3id.org/oac#", simple: true, prefix: true),
      ...
      "oav" => TermDefinition.new("oav", id: "http://lod.openaire.eu/vocab/", simple: true, prefix: true),
      ...
      "ocmv" => TermDefinition.new("ocmv", id: "https://w3id.org/ontouml-models/vocabulary#", simple: true, prefix: true),
      "oco" => TermDefinition.new("oco", id: "https://w3id.org/oc/ontology/", simple: true, prefix: true),
      "ocsw" => TermDefinition.new("ocsw", id: "http://data.diekb.org/def/ocsw#", simple: true, prefix: true),
      ...
      "ods" => TermDefinition.new("ods", id: "http://lod.xdams.org/ontologies/ods/", simple: true, prefix: true),
      ...
      "oeo" => TermDefinition.new("oeo", id: "http://openenergy-platform.org/ontology/oeo/", simple: true, prefix: true),
      ...
      "ofo" => TermDefinition.new("ofo", id: "https://w3id.org/ofo#", simple: true, prefix: true),
      "ofrd" => TermDefinition.new("ofrd", id: "http://purl.org/opdm/refrigerator#", simple: true, prefix: true),
      "og" => TermDefinition.new("og", id: "http://opengraphprotocol.org/schema/", simple: true, prefix: true),
      ...
      "ogcf" => TermDefinition.new("ogcf", id: "http://www.opengis.net/def/function/geosparql/", simple: true, prefix: true),
      "ogdl4m" => TermDefinition.new("ogdl4m", id: "https://github.com/martynui/OGDL4M/", simple: true, prefix: true),
      "ogham" => TermDefinition.new("ogham", id: "http://lod.ogham.link/data/", simple: true, prefix: true),
      "oghamonto" => TermDefinition.new("oghamonto", id: "http://ontology.ogham.link/", simple: true, prefix: true),
      ...
      "ogura" => TermDefinition.new("ogura", id: "https://sparql.crssnky.xyz/Ogura_Hyakunin_Isshu_LinkedRDF/URIs/Ogura_Hyakunin_Isshu_schema.ttl#", simple: true, prefix: true),
      "oh" => TermDefinition.new("oh", id: "http://semweb.mmlab.be/ns/oh#", simple: true, prefix: true),
      "oidc" => TermDefinition.new("oidc", id: "http://www.w3.org/ns/solid/oidc#", simple: true, prefix: true),
      "oils" => TermDefinition.new("oils", id: "http://lemon-model.net/oils#", simple: true, prefix: true),
      "oio" => TermDefinition.new("oio", id: "http://www.geneontology.org/formats/oboInOwl#", simple: true, prefix: true),
      ...
      "olias" => TermDefinition.new("olias", id: "http://purl.org/olia/system.owl#", simple: true, prefix: true),
      "oliasystem" => TermDefinition.new("oliasystem", id: "http://purl.org/olia/system.owl#", simple: true, prefix: true),
      "olis" => TermDefinition.new("olis", id: "http://olis.dev/", simple: true, prefix: true),
      ...
      "omim" => TermDefinition.new("omim", id: "http://purl.bioontology.org/ontology/OMIM/", simple: true, prefix: true),
      ...
      "ontobras" => TermDefinition.new("ontobras", id: "http://www.semanticweb.org/fefar/ontologies/ontobras#", simple: true, prefix: true),
      "ontolex" => TermDefinition.new("ontolex", id: "http://www.w3.org/ns/lemon/ontolex#", simple: true, prefix: true),
      "ontologia" => TermDefinition.new("ontologia", id: "http://ub.edu/dades/ontologia/Cinema#Cinemes#", simple: true, prefix: true),
      ...
      "ontouml" => TermDefinition.new("ontouml", id: "https://w3id.org/ontouml#", simple: true, prefix: true),
      ...
      "oplben" => TermDefinition.new("oplben", id: "http://www.openlinksw.com/ontology/benefits#", simple: true, prefix: true),
      ...
      "oplfeat" => TermDefinition.new("oplfeat", id: "http://www.openlinksw.com/ontology/features#", simple: true, prefix: true),
      ...
      "oplsoft" => TermDefinition.new("oplsoft", id: "http://www.openlinksw.com/ontology/software#", simple: true, prefix: true),
      "oplstocks" => TermDefinition.new("oplstocks", id: "http://www.openlinksw.com/ontology/stocks#", simple: true, prefix: true),
      "opltw" => TermDefinition.new("opltw", id: "http://www.openlinksw.com/schemas/twitter#", simple: true, prefix: true),
      ...
      "ops" => TermDefinition.new("ops", id: "https://w3id.org/ops#", simple: true, prefix: true),
      ...
      "ordo" => TermDefinition.new("ordo", id: "http://www.orpha.net/ORDO/", simple: true, prefix: true),
      ...
      "osdu" => TermDefinition.new("osdu", id: "https://w3id.org/OSDU#", simple: true, prefix: true),
      ...
      "osmm" => TermDefinition.new("osmm", id: "https://www.openstreetmap.org/meta/", simple: true, prefix: true),
      "osmnode" => TermDefinition.new("osmnode", id: "https://www.openstreetmap.org/node/", simple: true, prefix: true),
      "osmo" => TermDefinition.new("osmo", id: "https://purl.org/vimmp/osmo#", simple: true, prefix: true),
      "osmrel" => TermDefinition.new("osmrel", id: "https://www.openstreetmap.org/relation/", simple: true, prefix: true),
      "osmsemnet" => TermDefinition.new("osmsemnet", id: "http://spatial.ucd.ie/2012/08/osmsemnet/", simple: true, prefix: true),
      "osmt" => TermDefinition.new("osmt", id: "https://wiki.openstreetmap.org/wiki/Key:", simple: true, prefix: true),
      "osmway" => TermDefinition.new("osmway", id: "https://www.openstreetmap.org/way/", simple: true, prefix: true),
      ...
      "osys" => TermDefinition.new("osys", id: "http://purl.org/olia/system.owl#", simple: true, prefix: true),
      ...
      "p2po" => TermDefinition.new("p2po", id: "https://purl.org/p2p-o#", simple: true, prefix: true),
      "p3p" => TermDefinition.new("p3p", id: "http://www.w3.org/2002/01/p3prdfv1#", simple: true, prefix: true),
      "paam" => TermDefinition.new("paam", id: "https://lod.mediathek-tanz-theater.de/schema/paam/", simple: true, prefix: true),
      ...
      "pair" => TermDefinition.new("pair", id: "http://virtual-assembly.org/ontologies/pair#", simple: true, prefix: true),
      ...
      "pbac" => TermDefinition.new("pbac", id: "https://w3id.org/pbac#", simple: true, prefix: true),
      ...
      "pcp" => TermDefinition.new("pcp", id: "https://pcp-on-web.de/ontology/0.2/index-en.html#", simple: true, prefix: true),
      ...
      "peco" => TermDefinition.new("peco", id: "https://w3id.org/peco#", simple: true, prefix: true),
      ...
      "perscido" => TermDefinition.new("perscido", id: "https://perscido.univ-grenoble-alpes.fr/", simple: true, prefix: true),
      ...
      "persoon" => TermDefinition.new("persoon", id: "http://data.vlaanderen.be/ns/persoon#", simple: true, prefix: true),
      ...
      "pgo" => TermDefinition.new("pgo", id: "http://ii.uwb.edu.pl/pgo#", simple: true, prefix: true),
      "pgterms" => TermDefinition.new("pgterms", id: "http://www.gutenberg.org/2009/pgterms/", simple: true, prefix: true),
      "pgxo" => TermDefinition.new("pgxo", id: "http://pgxo.loria.fr/", simple: true, prefix: true),
      ...
      "pineapple" => TermDefinition.new("pineapple", id: "http://hexananas.com/pineapple#", simple: true, prefix: true),
      "ping" => TermDefinition.new("ping", id: "https://namso-gen.com/", simple: true, prefix: true),
      "pingback" => TermDefinition.new("pingback", id: "http://purl.org/net/pingback/", simple: true, prefix: true),
      "pit" => TermDefinition.new("pit", id: "http://data.elsevier.com/vocabulary/ElsevierPubItemTypes/", simple: true, prefix: true),
      ...
      "plant" => TermDefinition.new("plant", id: "http://example.org/plant/", simple: true, prefix: true),
      "plasma" => TermDefinition.new("plasma", id: "https://w3id.org/plasma#", simple: true, prefix: true),
      ...
      "pmd" => TermDefinition.new("pmd", id: "https://w3id.org/pmd/co/", simple: true, prefix: true),
      ...
      "pnv" => TermDefinition.new("pnv", id: "https://w3id.org/pnv#", simple: true, prefix: true),
      ...
      "poke" => TermDefinition.new("poke", id: "https://pokemonkg.org/ontology#", simple: true, prefix: true),
      ...
      "premis" => TermDefinition.new("premis", id: "http://www.loc.gov/premis/rdf/v3/", simple: true, prefix: true),
      ...
      "prismdb" => TermDefinition.new("prismdb", id: "https://prismdb.takanakahiko.me/prism-schema.ttl#", simple: true, prefix: true),
      ...
      "probont" => TermDefinition.new("probont", id: "http://www.probonto.org/ontology#", simple: true, prefix: true),
      ...
      "proton" => TermDefinition.new("proton", id: "http://www.ontotext.com/proton/", simple: true, prefix: true),
      ...
      "przecieki" => TermDefinition.new("przecieki", id: "http://onlyfans.com/emiliaszymanska/", simple: true, prefix: true),
      "ps" => TermDefinition.new("ps", id: "https://w3id.org/payswarm#", simple: true, prefix: true),
      "psh" => TermDefinition.new("psh", id: "http://ns.inria.fr/probabilistic-shacl/", simple: true, prefix: true),
      ...
      "psys" => TermDefinition.new("psys", id: "http://proton.semanticweb.org/protonsys#", simple: true, prefix: true),
      ...
      "pubchem" => TermDefinition.new("pubchem", id: "https://pubchem.ncbi.nlm.nih.gov/", simple: true, prefix: true),
      ...
      "qk" => TermDefinition.new("qk", id: "http://qudt.org/vocab/quantitykind/", simple: true, prefix: true),
      "qkdv" => TermDefinition.new("qkdv", id: "http://qudt.org/vocab/dimensionvector/", simple: true, prefix: true),
      ...
      "quest" => TermDefinition.new("quest", id: "https://rb.gy/ntg7l/", simple: true, prefix: true),
      "quid" => TermDefinition.new("quid", id: "https://w3id.org/quid/", simple: true, prefix: true),
      "quit" => TermDefinition.new("quit", id: "http://quit.aksw.org/vocab/", simple: true, prefix: true),
      "quran" => TermDefinition.new("quran", id: "http://khalidaloufi.sa/quran#", simple: true, prefix: true),
      ...
      "raad" => TermDefinition.new("raad", id: "https://raadzaam.nl/schema/", simple: true, prefix: true),
      ...
      "rank" => TermDefinition.new("rank", id: "http://www.ontotext.com/owlim/RDFRank#", simple: true, prefix: true),
      ...
      "raum" => TermDefinition.new("raum", id: "https://terminology.fraunhofer.de/voc/raum#", simple: true, prefix: true),
      "rb" => TermDefinition.new("rb", id: "https://w3id.org/riverbench/schema/metadata#", simple: true, prefix: true),
      "rbdoc" => TermDefinition.new("rbdoc", id: "https://w3id.org/riverbench/schema/documentation#", simple: true, prefix: true),
      "rc" => TermDefinition.new("rc", id: "https://w3id.org/rc#", simple: true, prefix: true),
      "rcgs" => TermDefinition.new("rcgs", id: "https://collection.rcgs.jp/terms/", simple: true, prefix: true),
      ...
      "rdaao" => TermDefinition.new("rdaao", id: "http://rdaregistry.info/Elements/a/object/", simple: true, prefix: true),
      ...
      "rdaed" => TermDefinition.new("rdaed", id: "http://rdaregistry.info/Elements/e/datatype/", simple: true, prefix: true),
      "rdaemm" => TermDefinition.new("rdaemm", id: "http://rdaregistry.info/termList/emulsionMicro/", simple: true, prefix: true),
      "rdaeo" => TermDefinition.new("rdaeo", id: "http://rdaregistry.info/Elements/e/object/", simple: true, prefix: true),
      "rdaep" => TermDefinition.new("rdaep", id: "http://rdaregistry.info/termList/RDAExtensionPlan/", simple: true, prefix: true),
      ...
      "rdaid" => TermDefinition.new("rdaid", id: "http://rdaregistry.info/Elements/i/datatype/", simple: true, prefix: true),
      "rdaill" => TermDefinition.new("rdaill", id: "http://rdaregistry.info/termList/IllusContent/", simple: true, prefix: true),
      "rdaim" => TermDefinition.new("rdaim", id: "http://rdaregistry.info/termList/RDAInteractivityMode/", simple: true, prefix: true),
      "rdaio" => TermDefinition.new("rdaio", id: "http://rdaregistry.info/Elements/i/object/", simple: true, prefix: true),
      ...
      "rdamat" => TermDefinition.new("rdamat", id: "http://rdaregistry.info/termList/RDAMaterial/", simple: true, prefix: true),
      "rdamd" => TermDefinition.new("rdamd", id: "http://rdaregistry.info/Elements/m/datatype/", simple: true, prefix: true),
      ...
      "rdamo" => TermDefinition.new("rdamo", id: "http://rdaregistry.info/Elements/m/object/", simple: true, prefix: true),
      "rdamt" => TermDefinition.new("rdamt", id: "http://rdaregistry.info/termList/RDAMediaType/", simple: true, prefix: true),
      "rdan" => TermDefinition.new("rdan", id: "http://rdaregistry.info/Elements/n/", simple: true, prefix: true),
      "rdand" => TermDefinition.new("rdand", id: "http://rdaregistry.info/Elements/n/datatype/", simple: true, prefix: true),
      "rdano" => TermDefinition.new("rdano", id: "http://rdaregistry.info/Elements/n/object/", simple: true, prefix: true),
      "rdap" => TermDefinition.new("rdap", id: "http://rdaregistry.info/Elements/p/", simple: true, prefix: true),
      "rdapath" => TermDefinition.new("rdapath", id: "http://rdaregistry.info/termList/RDARecordingMethods/", simple: true, prefix: true),
      "rdapd" => TermDefinition.new("rdapd", id: "http://rdaregistry.info/Elements/p/datatype/", simple: true, prefix: true),
      ...
      "rdasca" => TermDefinition.new("rdasca", id: "http://rdaregistry.info/termList/scale/", simple: true, prefix: true),
      ...
      "rdasource" => TermDefinition.new("rdasource", id: "http://rdaregistry.info/termList/RDARecordingSources/", simple: true, prefix: true),
      "rdaspc" => TermDefinition.new("rdaspc", id: "http://rdaregistry.info/termList/specPlayback/", simple: true, prefix: true),
      "rdat" => TermDefinition.new("rdat", id: "http://rdaregistry.info/Elements/t/", simple: true, prefix: true),
      "rdatask" => TermDefinition.new("rdatask", id: "http://rdaregistry.info/termList/RDATasks/", simple: true, prefix: true),
      "rdatb" => TermDefinition.new("rdatb", id: "http://rdaregistry.info/termList/RDATypeOfBinding/", simple: true, prefix: true),
      "rdatc" => TermDefinition.new("rdatc", id: "http://rdaregistry.info/termList/trackConfig/", simple: true, prefix: true),
      "rdatd" => TermDefinition.new("rdatd", id: "http://rdaregistry.info/Elements/t/datatype/", simple: true, prefix: true),
      "rdaterm" => TermDefinition.new("rdaterm", id: "http://rdaregistry.info/termList/RDATerms/", simple: true, prefix: true),
      "rdato" => TermDefinition.new("rdato", id: "http://rdaregistry.info/Elements/t/object/", simple: true, prefix: true),
      ...
      "rdaut" => TermDefinition.new("rdaut", id: "http://rdaregistry.info/termList/RDAUnitOfTime/", simple: true, prefix: true),
      ...
      "rdawd" => TermDefinition.new("rdawd", id: "http://rdaregistry.info/Elements/w/datatype/", simple: true, prefix: true),
      ...
      "react" => TermDefinition.new("react", id: "https://w3id.org/react#", simple: true, prefix: true),
      ...
      "relation" => TermDefinition.new("relation", id: "http://www.iana.org/assignments/relation/", simple: true, prefix: true),
      ...
      "resource" => TermDefinition.new("resource", id: "http://dbpedia.org/resource/", simple: true, prefix: true),
      "respond" => TermDefinition.new("respond", id: "https://w3id.org/respond#", simple: true, prefix: true),
      ...
      "risk" => TermDefinition.new("risk", id: "https://www.w3id.org/risk#", simple: true, prefix: true),
      "rism" => TermDefinition.new("rism", id: "http://rism.online/", simple: true, prefix: true),
      "rkd" => TermDefinition.new("rkd", id: "http://data.rkd.nl/def#", simple: true, prefix: true),
      "rl" => TermDefinition.new("rl", id: "http://rl.com/resources/", simple: true, prefix: true),
      ...
      "rml" => TermDefinition.new("rml", id: "http://w3id.org/rml/", simple: true, prefix: true),
      ...
      "rnce" => TermDefinition.new("rnce", id: "https://data.cultureelerfgoed.nl/id/rnce#", simple: true, prefix: true),
      ...
      "roar" => TermDefinition.new("roar", id: "https://w3id.org/roar#", simple: true, prefix: true),
      "robotarm" => TermDefinition.new("robotarm", id: "https://solid.ti.rw.fau.de/public/ns/robotArm#", simple: true, prefix: true),
      ...
      "rofchrda" => TermDefinition.new("rofchrda", id: "http://rdaregistry.info/termList/rofchrda/", simple: true, prefix: true),
      ...
      "roffgrda" => TermDefinition.new("roffgrda", id: "http://rdaregistry.info/termList/roffgrda/", simple: true, prefix: true),
      ...
      "rofitrda" => TermDefinition.new("rofitrda", id: "http://rdaregistry.info/termList/rofitrda/", simple: true, prefix: true),
      ...
      "rofsfrda" => TermDefinition.new("rofsfrda", id: "http://rdaregistry.info/termList/rofsfrda/", simple: true, prefix: true),
      "rofsm" => TermDefinition.new("rofsm", id: "http://rdaregistry.info/termList/rofsm/", simple: true, prefix: true),
      "roh" => TermDefinition.new("roh", id: "http://w3id.org/roh#", simple: true, prefix: true),
      ...
      "rro" => TermDefinition.new("rro", id: "http://semanticweb.org/patricia/ontologies/rro#", simple: true, prefix: true),
      ...
      "rsp" => TermDefinition.new("rsp", id: "http://www.researchspace.org/resource/", simple: true, prefix: true),
      ...
      "rsx" => TermDefinition.new("rsx", id: "http://rdf4j.org/shacl-extensions#", simple: true, prefix: true),
      "rtedurp" => TermDefinition.new("rtedurp", id: "http://purl.org/eduo/rtedurp/", simple: true, prefix: true),
      ...
      "s223" => TermDefinition.new("s223", id: "http://data.ashrae.org/standard223#", simple: true, prefix: true),
      ...
      "s4agri" => TermDefinition.new("s4agri", id: "https://saref.etsi.org/saref4agri/", simple: true, prefix: true),
      "s4bldg" => TermDefinition.new("s4bldg", id: "https://w3id.org/def/saref4bldg#", simple: true, prefix: true),
      "s4city" => TermDefinition.new("s4city", id: "https://saref.etsi.org/saref4city/", simple: true, prefix: true),
      "s4ee" => TermDefinition.new("s4ee", id: "https://w3id.org/saref4ee#", simple: true, prefix: true),
      "s4ener" => TermDefinition.new("s4ener", id: "https://saref.etsi.org/saref4ener/", simple: true, prefix: true),
      ...
      "samian" => TermDefinition.new("samian", id: "http://lod.archaeology.link/data/samian/", simple: true, prefix: true),
      ...
      "saref" => TermDefinition.new("saref", id: "https://saref.etsi.org/core/", simple: true, prefix: true),
      "saref4envi" => TermDefinition.new("saref4envi", id: "https://saref.etsi.org/saref4envi/", simple: true, prefix: true),
      ...
      "say" => TermDefinition.new("say", id: "http://example.org/say/", simple: true, prefix: true),
      ...
      "schoi" => TermDefinition.new("schoi", id: "https://w3id.org/scholarlydata/ontology/indicators-ontology.owl#", simple: true, prefix: true),
      ...
      "sct" => TermDefinition.new("sct", id: "http://snomed.info/id/", simple: true, prefix: true),
      ...
      "sdo" => TermDefinition.new("sdo", id: "https://schema.org/", simple: true, prefix: true),
      "sds" => TermDefinition.new("sds", id: "https://w3id.org/sds#", simple: true, prefix: true),
      ...
      "semapv" => TermDefinition.new("semapv", id: "https://w3id.org/semapv/vocab/", simple: true, prefix: true),
      ...
      "sense" => TermDefinition.new("sense", id: "https://w3id.org/sense#", simple: true, prefix: true),
      ...
      "sg" => TermDefinition.new("sg", id: "http://name.scigraph.com/ontologies/core/", simple: true, prefix: true),
      ...
      "she" => TermDefinition.new("she", id: "http://shacleditor.org/", simple: true, prefix: true),
      "shema" => TermDefinition.new("shema", id: "http://schema.org/", simple: true, prefix: true),
      "shex" => TermDefinition.new("shex", id: "http://www.w3.org/ns/shex#", simple: true, prefix: true),
      ...
      "sim" => TermDefinition.new("sim", id: "http://www.w3id.org/simulation/ontology/", simple: true, prefix: true),
      ...
      "sirext" => TermDefinition.new("sirext", id: "http://t.me/sirextt/247:", simple: true, prefix: true),
      ...
      "skoslex" => TermDefinition.new("skoslex", id: "https://bp4mc2.org/def/skos-lex#", simple: true, prefix: true),
      "skosm" => TermDefinition.new("skosm", id: "http://www.w3.org/2004/02/skos/mapping#", simple: true, prefix: true),
      "skosno" => TermDefinition.new("skosno", id: "http://data.norge.no/skosno#", simple: true, prefix: true),
      ...
      "sml" => TermDefinition.new("sml", id: "https://w3id.org/sml/def#", simple: true, prefix: true),
      ...
      "snomedct" => TermDefinition.new("snomedct", id: "http://purl.bioontology.org/ontology/SNOMEDCT/", simple: true, prefix: true),
      "so" => TermDefinition.new("so", id: "http://schema.org/", simple: true, prefix: true),
      "soa" => TermDefinition.new("soa", id: "https://semopenalex.org/ontology/", simple: true, prefix: true),
      "soall" => TermDefinition.new("soall", id: "http://sweetontology.net/sweetAll/", simple: true, prefix: true),
      ...
      "sohu" => TermDefinition.new("sohu", id: "http://sweetontology.net/human/", simple: true, prefix: true),
      "sohua" => TermDefinition.new("sohua", id: "http://sweetontology.net/humanAgriculture/", simple: true, prefix: true),
      "sohuc" => TermDefinition.new("sohuc", id: "http://sweetontology.net/humanCommerce/", simple: true, prefix: true),
      "sohud" => TermDefinition.new("sohud", id: "http://sweetontology.net/humanDecision/", simple: true, prefix: true),
      "sohuea" => TermDefinition.new("sohuea", id: "http://sweetontology.net/humanEnvirAssessment/", simple: true, prefix: true),
      "sohueccont" => TermDefinition.new("sohueccont", id: "http://sweetontology.net/humanEnvirControl/", simple: true, prefix: true),
      "sohuecons" => TermDefinition.new("sohuecons", id: "http://sweetontology.net/humanEnvirConservation/", simple: true, prefix: true),
      "sohues" => TermDefinition.new("sohues", id: "http://sweetontology.net/humanEnvirStandards/", simple: true, prefix: true),
      "sohuj" => TermDefinition.new("sohuj", id: "http://sweetontology.net/humanJurisdiction/", simple: true, prefix: true),
      "sohukd" => TermDefinition.new("sohukd", id: "http://sweetontology.net/humanKnowledgeDomain/", simple: true, prefix: true),
      "sohur" => TermDefinition.new("sohur", id: "http://sweetontology.net/humanResearch/", simple: true, prefix: true),
      "sohut" => TermDefinition.new("sohut", id: "http://sweetontology.net/humanTransportation/", simple: true, prefix: true),
      "sohutr" => TermDefinition.new("sohutr", id: "http://sweetontology.net/humanTechReadiness/", simple: true, prefix: true),
      "solid" => TermDefinition.new("solid", id: "http://www.w3.org/ns/solid/terms#", simple: true, prefix: true),
      "soma" => TermDefinition.new("soma", id: "http://sweetontology.net/matr/", simple: true, prefix: true),
      "somaae" => TermDefinition.new("somaae", id: "http://sweetontology.net/matrAerosol/", simple: true, prefix: true),
      "somab" => TermDefinition.new("somab", id: "http://sweetontology.net/matrBiomass/", simple: true, prefix: true),
      "somac" => TermDefinition.new("somac", id: "http://sweetontology.net/matrCompound/", simple: true, prefix: true),
      "somael" => TermDefinition.new("somael", id: "http://sweetontology.net/matrElement/", simple: true, prefix: true),
      "somaem" => TermDefinition.new("somaem", id: "http://sweetontology.net/matrElementalMolecule/", simple: true, prefix: true),
      "somaen" => TermDefinition.new("somaen", id: "http://sweetontology.net/matrEnergy/", simple: true, prefix: true),
      "somaeq" => TermDefinition.new("somaeq", id: "http://sweetontology.net/matrEquipment/", simple: true, prefix: true),
      "somaf" => TermDefinition.new("somaf", id: "http://sweetontology.net/matrFacility/", simple: true, prefix: true),
      "somaind" => TermDefinition.new("somaind", id: "http://sweetontology.net/matrIndustrial/", simple: true, prefix: true),
      "somains" => TermDefinition.new("somains", id: "http://sweetontology.net/matrInstrument/", simple: true, prefix: true),
      "somaio" => TermDefinition.new("somaio", id: "http://sweetontology.net/matrIon/", simple: true, prefix: true),
      "somais" => TermDefinition.new("somais", id: "http://sweetontology.net/matrIsotope/", simple: true, prefix: true),
      "somamic" => TermDefinition.new("somamic", id: "http://sweetontology.net/matrMicrobiota/", simple: true, prefix: true),
      "somamin" => TermDefinition.new("somamin", id: "http://sweetontology.net/matrMineral/", simple: true, prefix: true),
      "soman" => TermDefinition.new("soman", id: "http://sweetontology.net/matrAnimal/", simple: true, prefix: true),
      "somanr" => TermDefinition.new("somanr", id: "http://sweetontology.net/matrNaturalResource/", simple: true, prefix: true),
      "somaoc" => TermDefinition.new("somaoc", id: "http://sweetontology.net/matrOrganicCompound/", simple: true, prefix: true),
      "somapa" => TermDefinition.new("somapa", id: "http://sweetontology.net/matrParticle/", simple: true, prefix: true),
      "somapl" => TermDefinition.new("somapl", id: "http://sweetontology.net/matrPlant/", simple: true, prefix: true),
      "somarock" => TermDefinition.new("somarock", id: "http://sweetontology.net/matrRock/", simple: true, prefix: true),
      "somarocki" => TermDefinition.new("somarocki", id: "http://sweetontology.net/matrRockIgneous/", simple: true, prefix: true),
      "somas" => TermDefinition.new("somas", id: "http://sweetontology.net/matrSediment/", simple: true, prefix: true),
      "somaw" => TermDefinition.new("somaw", id: "http://sweetontology.net/matrWater/", simple: true, prefix: true),
      "soph" => TermDefinition.new("soph", id: "http://sweetontology.net/phen/", simple: true, prefix: true),
      "sophatmo" => TermDefinition.new("sophatmo", id: "http://sweetontology.net/phenAtmo/", simple: true, prefix: true),
      "sophatmoc" => TermDefinition.new("sophatmoc", id: "http://sweetontology.net/phenAtmoCloud/", simple: true, prefix: true),
      "sophatmofo" => TermDefinition.new("sophatmofo", id: "http://sweetontology.net/phenAtmoFog/", simple: true, prefix: true),
      "sophatmofr" => TermDefinition.new("sophatmofr", id: "http://sweetontology.net/phenAtmoFront/", simple: true, prefix: true),
      "sophatmol" => TermDefinition.new("sophatmol", id: "http://sweetontology.net/phenAtmoLightning/", simple: true, prefix: true),
      "sophatmopc" => TermDefinition.new("sophatmopc", id: "http://sweetontology.net/phenAtmoPrecipitation/", simple: true, prefix: true),
      "sophatmops" => TermDefinition.new("sophatmops", id: "http://sweetontology.net/phenAtmoPressure/", simple: true, prefix: true),
      "sophatmos" => TermDefinition.new("sophatmos", id: "http://sweetontology.net/phenAtmoSky/", simple: true, prefix: true),
      "sophatmot" => TermDefinition.new("sophatmot", id: "http://sweetontology.net/phenAtmoTransport/", simple: true, prefix: true),
      "sophatmow" => TermDefinition.new("sophatmow", id: "http://sweetontology.net/phenAtmoWind/", simple: true, prefix: true),
      "sophatmowm" => TermDefinition.new("sophatmowm", id: "https://sweetontology.net/phenAtmoWindMesoscale/", simple: true, prefix: true),
      "sophb" => TermDefinition.new("sophb", id: "http://sweetontology.net/phenBiol/", simple: true, prefix: true),
      "sophcm" => TermDefinition.new("sophcm", id: "http://sweetontology.net/phenCycleMaterial/", simple: true, prefix: true),
      "sophcr" => TermDefinition.new("sophcr", id: "http://sweetontology.net/phenCryo/", simple: true, prefix: true),
      "sophcy" => TermDefinition.new("sophcy", id: "http://sweetontology.net/phenCycle/", simple: true, prefix: true),
      "sophec" => TermDefinition.new("sophec", id: "http://sweetontology.net/phenEcology/", simple: true, prefix: true),
      "sophei" => TermDefinition.new("sophei", id: "http://sweetontology.net/phenEnvirImpact/", simple: true, prefix: true),
      "sophel" => TermDefinition.new("sophel", id: "http://sweetontology.net/phenElecMag/", simple: true, prefix: true),
      "sophen" => TermDefinition.new("sophen", id: "http://sweetontology.net/phenEnergy/", simple: true, prefix: true),
      "sophfd" => TermDefinition.new("sophfd", id: "http://sweetontology.net/phenFluidDynamics/", simple: true, prefix: true),
      "sophfi" => TermDefinition.new("sophfi", id: "http://sweetontology.net/phenFluidInstability/", simple: true, prefix: true),
      "sophft" => TermDefinition.new("sophft", id: "http://sweetontology.net/phenFluidTransport/", simple: true, prefix: true),
      "sophg" => TermDefinition.new("sophg", id: "http://sweetontology.net/phenGeol/", simple: true, prefix: true),
      "sophgf" => TermDefinition.new("sophgf", id: "http://sweetontology.net/phenGeolFault/", simple: true, prefix: true),
      "sophgg" => TermDefinition.new("sophgg", id: "http://sweetontology.net/phenGeolGeomorphology/", simple: true, prefix: true),
      "sophgs" => TermDefinition.new("sophgs", id: "http://sweetontology.net/phenGeolSeismicity/", simple: true, prefix: true),
      "sophgt" => TermDefinition.new("sophgt", id: "http://sweetontology.net/phenGeolTectonic/", simple: true, prefix: true),
      "sophgv" => TermDefinition.new("sophgv", id: "http://sweetontology.net/phenGeolVolcano/", simple: true, prefix: true),
      "sophhe" => TermDefinition.new("sophhe", id: "http://sweetontology.net/phenHelio/", simple: true, prefix: true),
      "sophhy" => TermDefinition.new("sophhy", id: "http://sweetontology.net/phenHydro/", simple: true, prefix: true),
      "sophm" => TermDefinition.new("sophm", id: "http://sweetontology.net/phenMixing/", simple: true, prefix: true),
      "sopho" => TermDefinition.new("sopho", id: "http://sweetontology.net/phenOcean/", simple: true, prefix: true),
      "sophoc" => TermDefinition.new("sophoc", id: "http://sweetontology.net/phenOceanCoastal/", simple: true, prefix: true),
      "sophod" => TermDefinition.new("sophod", id: "http://sweetontology.net/phenOceanDynamics/", simple: true, prefix: true),
      "sophpc" => TermDefinition.new("sophpc", id: "http://sweetontology.net/phenPlanetClimate/", simple: true, prefix: true),
      "sophr" => TermDefinition.new("sophr", id: "http://sweetontology.net/phenReaction/", simple: true, prefix: true),
      "sophso" => TermDefinition.new("sophso", id: "http://sweetontology.net/phenSolid/", simple: true, prefix: true),
      "sophst" => TermDefinition.new("sophst", id: "http://sweetontology.net/phenStar/", simple: true, prefix: true),
      "sophsy" => TermDefinition.new("sophsy", id: "http://sweetontology.net/phenSystem/", simple: true, prefix: true),
      "sophsyc" => TermDefinition.new("sophsyc", id: "http://sweetontology.net/phenSystemComplexity/", simple: true, prefix: true),
      "sophw" => TermDefinition.new("sophw", id: "http://sweetontology.net/phenWave/", simple: true, prefix: true),
      "sophwn" => TermDefinition.new("sophwn", id: "http://sweetontology.net/phenWaveNoise/", simple: true, prefix: true),
      "soproc" => TermDefinition.new("soproc", id: "http://sweetontology.net/proc/", simple: true, prefix: true),
      "soprocc" => TermDefinition.new("soprocc", id: "http://sweetontology.net/procChemical/", simple: true, prefix: true),
      "soprocp" => TermDefinition.new("soprocp", id: "http://sweetontology.net/procPhysical/", simple: true, prefix: true),
      "soprocsc" => TermDefinition.new("soprocsc", id: "http://sweetontology.net/procStateChange/", simple: true, prefix: true),
      "soprocw" => TermDefinition.new("soprocw", id: "http://sweetontology.net/procWave/", simple: true, prefix: true),
      "soprop" => TermDefinition.new("soprop", id: "http://sweetontology.net/prop/", simple: true, prefix: true),
      "sopropb" => TermDefinition.new("sopropb", id: "http://sweetontology.net/propBinary/", simple: true, prefix: true),
      "sopropcap" => TermDefinition.new("sopropcap", id: "http://sweetontology.net/propCapacity/", simple: true, prefix: true),
      "sopropcat" => TermDefinition.new("sopropcat", id: "http://sweetontology.net/propCategorical/", simple: true, prefix: true),
      "sopropcha" => TermDefinition.new("sopropcha", id: "http://sweetontology.net/propCharge/", simple: true, prefix: true),
      "sopropche" => TermDefinition.new("sopropche", id: "http://sweetontology.net/propChemical/", simple: true, prefix: true),
      "sopropcon" => TermDefinition.new("sopropcon", id: "http://sweetontology.net/propConductivity/", simple: true, prefix: true),
      "sopropcou" => TermDefinition.new("sopropcou", id: "http://sweetontology.net/propCount/", simple: true, prefix: true),
      "sopropdife" => TermDefinition.new("sopropdife", id: "http://sweetontology.net/propDifference/", simple: true, prefix: true),
      "sopropdifu" => TermDefinition.new("sopropdifu", id: "http://sweetontology.net/propDiffusivity/", simple: true, prefix: true),
      "sopropdr" => TermDefinition.new("sopropdr", id: "http://sweetontology.net/propDimensionlessRatio/", simple: true, prefix: true),
      "soprope" => TermDefinition.new("soprope", id: "http://sweetontology.net/propEnergy/", simple: true, prefix: true),
      "sopropef" => TermDefinition.new("sopropef", id: "http://sweetontology.net/propEnergyFlux/", simple: true, prefix: true),
      "sopropfr" => TermDefinition.new("sopropfr", id: "http://sweetontology.net/propFraction/", simple: true, prefix: true),
      "sopropfu" => TermDefinition.new("sopropfu", id: "http://sweetontology.net/propFunction/", simple: true, prefix: true),
      "sopropi" => TermDefinition.new("sopropi", id: "http://sweetontology.net/propIndex/", simple: true, prefix: true),
      "sopropm" => TermDefinition.new("sopropm", id: "http://sweetontology.net/propMass/", simple: true, prefix: true),
      "sopropmf" => TermDefinition.new("sopropmf", id: "http://sweetontology.net/propMassFlux/", simple: true, prefix: true),
      "sopropo" => TermDefinition.new("sopropo", id: "http://sweetontology.net/propOrdinal/", simple: true, prefix: true),
      "sopropp" => TermDefinition.new("sopropp", id: "http://sweetontology.net/propPressure/", simple: true, prefix: true),
      "sopropq" => TermDefinition.new("sopropq", id: "http://sweetontology.net/propQuantity/", simple: true, prefix: true),
      "sopropr" => TermDefinition.new("sopropr", id: "http://sweetontology.net/propRotation/", simple: true, prefix: true),
      "soprops" => TermDefinition.new("soprops", id: "http://sweetontology.net/propSpace/", simple: true, prefix: true),
      "sopropsdir" => TermDefinition.new("sopropsdir", id: "http://sweetontology.net/propSpaceDirection/", simple: true, prefix: true),
      "sopropsdis" => TermDefinition.new("sopropsdis", id: "http://sweetontology.net/propSpaceDistance/", simple: true, prefix: true),
      "sopropsh" => TermDefinition.new("sopropsh", id: "http://sweetontology.net/propSpaceHeight/", simple: true, prefix: true),
      "sopropsl" => TermDefinition.new("sopropsl", id: "http://sweetontology.net/propSpaceLocation/", simple: true, prefix: true),
      "sopropsm" => TermDefinition.new("sopropsm", id: "http://sweetontology.net/propSpaceMultidimensional/", simple: true, prefix: true),
      "sopropsp" => TermDefinition.new("sopropsp", id: "http://sweetontology.net/propSpeed/", simple: true, prefix: true),
      "sopropst" => TermDefinition.new("sopropst", id: "http://sweetontology.net/propSpaceThickness/", simple: true, prefix: true),
      "sopropt" => TermDefinition.new("sopropt", id: "http://sweetontology.net/propTemperature/", simple: true, prefix: true),
      "soproptf" => TermDefinition.new("soproptf", id: "http://sweetontology.net/propTimeFrequency/", simple: true, prefix: true),
      "soproptg" => TermDefinition.new("soproptg", id: "http://sweetontology.net/propTemperatureGradient/", simple: true, prefix: true),
      "sopropti" => TermDefinition.new("sopropti", id: "http://sweetontology.net/propTime/", simple: true, prefix: true),
      "sor" => TermDefinition.new("sor", id: "http://purl.org/net/soron/", simple: true, prefix: true),
      "sorea" => TermDefinition.new("sorea", id: "http://sweetontology.net/realm/", simple: true, prefix: true),
      "soreaa" => TermDefinition.new("soreaa", id: "http://sweetontology.net/realmAtmo/", simple: true, prefix: true),
      "soreaab" => TermDefinition.new("soreaab", id: "http://sweetontology.net/realmAstroBody/", simple: true, prefix: true),
      "soreaabl" => TermDefinition.new("soreaabl", id: "http://sweetontology.net/realmAtmoBoundaryLayer/", simple: true, prefix: true),
      "soreaah" => TermDefinition.new("soreaah", id: "http://sweetontology.net/realmAstroHelio/", simple: true, prefix: true),
      "soreaas" => TermDefinition.new("soreaas", id: "http://sweetontology.net/realmAstroStar/", simple: true, prefix: true),
      "soreaaw" => TermDefinition.new("soreaaw", id: "http://sweetontology.net/realmAtmoWeather/", simple: true, prefix: true),
      "soreabb" => TermDefinition.new("soreabb", id: "http://sweetontology.net/realmBiolBiome/", simple: true, prefix: true),
      "soreac" => TermDefinition.new("soreac", id: "http://sweetontology.net/realmCryo/", simple: true, prefix: true),
      "soreacz" => TermDefinition.new("soreacz", id: "http://sweetontology.net/realmClimateZone/", simple: true, prefix: true),
      "soreaer" => TermDefinition.new("soreaer", id: "http://sweetontology.net/realmEarthReference/", simple: true, prefix: true),
      "soreahb" => TermDefinition.new("soreahb", id: "http://sweetontology.net/realmHydroBody/", simple: true, prefix: true),
      "soreal" => TermDefinition.new("soreal", id: "http://sweetontology.net/realmLandform/", simple: true, prefix: true),
      "soreala" => TermDefinition.new("soreala", id: "http://sweetontology.net/realmLandAeolian/", simple: true, prefix: true),
      "sorealc" => TermDefinition.new("sorealc", id: "http://sweetontology.net/realmLandCoastal/", simple: true, prefix: true),
      "sorealf" => TermDefinition.new("sorealf", id: "http://sweetontology.net/realmLandFluvial/", simple: true, prefix: true),
      "sorealg" => TermDefinition.new("sorealg", id: "http://sweetontology.net/realmLandGlacial/", simple: true, prefix: true),
      "sorealo" => TermDefinition.new("sorealo", id: "http://sweetontology.net/realmLandOrographic/", simple: true, prefix: true),
      "sorealp" => TermDefinition.new("sorealp", id: "http://sweetontology.net/realmLandProtected/", simple: true, prefix: true),
      "sorealt" => TermDefinition.new("sorealt", id: "http://sweetontology.net/realmLandTectonic/", simple: true, prefix: true),
      "sorealv" => TermDefinition.new("sorealv", id: "http://sweetontology.net/realmLandVolcanic/", simple: true, prefix: true),
      "soreao" => TermDefinition.new("soreao", id: "http://sweetontology.net/realmOcean/", simple: true, prefix: true),
      "soreaofe" => TermDefinition.new("soreaofe", id: "http://sweetontology.net/realmOceanFeature/", simple: true, prefix: true),
      "soreaofl" => TermDefinition.new("soreaofl", id: "http://sweetontology.net/realmOceanFloor/", simple: true, prefix: true),
      "sorear" => TermDefinition.new("sorear", id: "http://sweetontology.net/realmRegion/", simple: true, prefix: true),
      "soreas" => TermDefinition.new("soreas", id: "http://sweetontology.net/realmSoil/", simple: true, prefix: true),
      "sorel" => TermDefinition.new("sorel", id: "http://sweetontology.net/rela/", simple: true, prefix: true),
      "sorelch" => TermDefinition.new("sorelch", id: "http://sweetontology.net/relaChemical/", simple: true, prefix: true),
      "sorelcl" => TermDefinition.new("sorelcl", id: "http://sweetontology.net/relaClimate/", simple: true, prefix: true),
      "sorelh" => TermDefinition.new("sorelh", id: "http://sweetontology.net/relaHuman/", simple: true, prefix: true),
      "sorelm" => TermDefinition.new("sorelm", id: "http://sweetontology.net/relaMath/", simple: true, prefix: true),
      "sorelph" => TermDefinition.new("sorelph", id: "http://sweetontology.net/relaPhysical/", simple: true, prefix: true),
      "sorelpr" => TermDefinition.new("sorelpr", id: "http://sweetontology.net/relaProvenance/", simple: true, prefix: true),
      "sorelsc" => TermDefinition.new("sorelsc", id: "http://sweetontology.net/relaSci/", simple: true, prefix: true),
      "sorelsp" => TermDefinition.new("sorelsp", id: "http://sweetontology.net/relaSpace/", simple: true, prefix: true),
      "sorelt" => TermDefinition.new("sorelt", id: "http://sweetontology.net/relaTime/", simple: true, prefix: true),
      "sorep" => TermDefinition.new("sorep", id: "http://sweetontology.net/repr/", simple: true, prefix: true),
      "sorepdf" => TermDefinition.new("sorepdf", id: "http://sweetontology.net/reprDataFormat/", simple: true, prefix: true),
      "sorepdm" => TermDefinition.new("sorepdm", id: "http://sweetontology.net/reprDataModel/", simple: true, prefix: true),
      "sorepdp" => TermDefinition.new("sorepdp", id: "http://sweetontology.net/reprDataProduct/", simple: true, prefix: true),
      "sorepds" => TermDefinition.new("sorepds", id: "http://sweetontology.net/reprDataService/", simple: true, prefix: true),
      "sorepdsa" => TermDefinition.new("sorepdsa", id: "http://sweetontology.net/reprDataServiceAnalysis/", simple: true, prefix: true),
      "sorepdsg" => TermDefinition.new("sorepdsg", id: "http://sweetontology.net/reprDataServiceGeospatial/", simple: true, prefix: true),
      "sorepdsr" => TermDefinition.new("sorepdsr", id: "http://sweetontology.net/reprDataServiceReduction/", simple: true, prefix: true),
      "sorepdsv" => TermDefinition.new("sorepdsv", id: "http://sweetontology.net/reprDataServiceValidation/", simple: true, prefix: true),
      "sorepm" => TermDefinition.new("sorepm", id: "http://sweetontology.net/reprMath/", simple: true, prefix: true),
      "sorepmf" => TermDefinition.new("sorepmf", id: "http://sweetontology.net/reprMathFunction/", simple: true, prefix: true),
      "sorepmfo" => TermDefinition.new("sorepmfo", id: "http://sweetontology.net/reprMathFunctionOrthogonal/", simple: true, prefix: true),
      "sorepmg" => TermDefinition.new("sorepmg", id: "http://sweetontology.net/reprMathGraph/", simple: true, prefix: true),
      "sorepmo" => TermDefinition.new("sorepmo", id: "http://sweetontology.net/reprMathOperation/", simple: true, prefix: true),
      "sorepmso" => TermDefinition.new("sorepmso", id: "http://sweetontology.net/reprMathSolution/", simple: true, prefix: true),
      "sorepmst" => TermDefinition.new("sorepmst", id: "http://sweetontology.net/reprMathStatistics/", simple: true, prefix: true),
      "soreps" => TermDefinition.new("soreps", id: "http://sweetontology.net/reprSpace/", simple: true, prefix: true),
      "sorepsc" => TermDefinition.new("sorepsc", id: "http://sweetontology.net/reprSciComponent/", simple: true, prefix: true),
      "sorepscd" => TermDefinition.new("sorepscd", id: "http://sweetontology.net/reprSpaceCoordinate/", simple: true, prefix: true),
      "sorepsd" => TermDefinition.new("sorepsd", id: "http://sweetontology.net/reprSpaceDirection/", simple: true, prefix: true),
      "sorepsf" => TermDefinition.new("sorepsf", id: "http://sweetontology.net/reprSciFunction/", simple: true, prefix: true),
      "sorepsg3" => TermDefinition.new("sorepsg3", id: "http://sweetontology.net/reprSpaceGeometry3D/", simple: true, prefix: true),
      "sorepsl" => TermDefinition.new("sorepsl", id: "http://sweetontology.net/reprSciLaw/", simple: true, prefix: true),
      "sorepsme" => TermDefinition.new("sorepsme", id: "http://sweetontology.net/reprSciMethodology/", simple: true, prefix: true),
      "sorepsmo" => TermDefinition.new("sorepsmo", id: "http://sweetontology.net/reprSciModel/", simple: true, prefix: true),
      "sorepsp" => TermDefinition.new("sorepsp", id: "http://sweetontology.net/reprSciProvenance/", simple: true, prefix: true),
      "sorepsrs" => TermDefinition.new("sorepsrs", id: "http://sweetontology.net/reprSpaceReferenceSystem/", simple: true, prefix: true),
      "sorepsu" => TermDefinition.new("sorepsu", id: "http://sweetontology.net/reprSciUnits/", simple: true, prefix: true),
      "sorept" => TermDefinition.new("sorept", id: "http://sweetontology.net/reprTime/", simple: true, prefix: true),
      "soreptd" => TermDefinition.new("soreptd", id: "http://sweetontology.net/reprTimeDay/", simple: true, prefix: true),
      "sorepts" => TermDefinition.new("sorepts", id: "http://sweetontology.net/reprTimeSeason/", simple: true, prefix: true),
      ...
      "sost" => TermDefinition.new("sost", id: "http://sweetontology.net/state/", simple: true, prefix: true),
      "sostb" => TermDefinition.new("sostb", id: "http://sweetontology.net/stateBiological/", simple: true, prefix: true),
      "sostc" => TermDefinition.new("sostc", id: "http://sweetontology.net/stateChemical/", simple: true, prefix: true),
      "sostdp" => TermDefinition.new("sostdp", id: "http://sweetontology.net/stateDataProcessing/", simple: true, prefix: true),
      "sostef" => TermDefinition.new("sostef", id: "http://sweetontology.net/stateEnergyFlux/", simple: true, prefix: true),
      "sostf" => TermDefinition.new("sostf", id: "http://sweetontology.net/stateFluid/", simple: true, prefix: true),
      "sosto" => TermDefinition.new("sosto", id: "http://sweetontology.net/stateOrdinal/", simple: true, prefix: true),
      "sostp" => TermDefinition.new("sostp", id: "http://sweetontology.net/statePhysical/", simple: true, prefix: true),
      "sostrb" => TermDefinition.new("sostrb", id: "http://sweetontology.net/stateRoleBiological/", simple: true, prefix: true),
      "sostrc" => TermDefinition.new("sostrc", id: "http://sweetontology.net/stateRoleChemical/", simple: true, prefix: true),
      "sostre" => TermDefinition.new("sostre", id: "http://sweetontology.net/stateRealm/", simple: true, prefix: true),
      "sostrg" => TermDefinition.new("sostrg", id: "http://sweetontology.net/stateRoleGeographic/", simple: true, prefix: true),
      "sostri" => TermDefinition.new("sostri", id: "http://sweetontology.net/stateRoleImpact/", simple: true, prefix: true),
      "sostro" => TermDefinition.new("sostro", id: "http://sweetontology.net/stateRole/", simple: true, prefix: true),
      "sostrr" => TermDefinition.new("sostrr", id: "http://sweetontology.net/stateRoleRepresentative/", simple: true, prefix: true),
      "sostrt" => TermDefinition.new("sostrt", id: "http://sweetontology.net/stateRoleTrust/", simple: true, prefix: true),
      "sostsb" => TermDefinition.new("sostsb", id: "http://sweetontology.net/stateSpectralBand/", simple: true, prefix: true),
      "sostsc" => TermDefinition.new("sostsc", id: "http://sweetontology.net/stateSpaceConfiguration/", simple: true, prefix: true),
      "sostsl" => TermDefinition.new("sostsl", id: "http://sweetontology.net/stateSpectralLine/", simple: true, prefix: true),
      "sostso" => TermDefinition.new("sostso", id: "http://sweetontology.net/stateSolid/", simple: true, prefix: true),
      "sostsp" => TermDefinition.new("sostsp", id: "http://sweetontology.net/stateSpace/", simple: true, prefix: true),
      "sostss" => TermDefinition.new("sostss", id: "http://sweetontology.net/stateSpaceScale/", simple: true, prefix: true),
      "sostst" => TermDefinition.new("sostst", id: "http://sweetontology.net/stateStorm/", simple: true, prefix: true),
      "sostsy" => TermDefinition.new("sostsy", id: "http://sweetontology.net/stateSystem/", simple: true, prefix: true),
      "sosttc" => TermDefinition.new("sosttc", id: "http://sweetontology.net/stateTimeCycle/", simple: true, prefix: true),
      "sosttf" => TermDefinition.new("sosttf", id: "http://sweetontology.net/stateTimeFrequency/", simple: true, prefix: true),
      "sosttg" => TermDefinition.new("sosttg", id: "http://sweetontology.net/stateTimeGeologic/", simple: true, prefix: true),
      "sostth" => TermDefinition.new("sostth", id: "http://sweetontology.net/stateThermodynamic/", simple: true, prefix: true),
      "sostti" => TermDefinition.new("sostti", id: "http://sweetontology.net/stateTime/", simple: true, prefix: true),
      "sostv" => TermDefinition.new("sostv", id: "http://sweetontology.net/stateVisibility/", simple: true, prefix: true),
      "sou" => TermDefinition.new("sou", id: "http://qudt.org/vocab/sou/", simple: true, prefix: true),
      ...
      "spatialf" => TermDefinition.new("spatialf", id: "http://jena.apache.org/function/spatial#", simple: true, prefix: true),
      ...
      "spec" => TermDefinition.new("spec", id: "http://www.w3.org/ns/spec#", simple: true, prefix: true),
      ...
      "sport" => TermDefinition.new("sport", id: "http://purl.org/ontology/sport/", simple: true, prefix: true),
      ...
      "sri" => TermDefinition.new("sri", id: "https://w3id.org/sri#", simple: true, prefix: true),
      "srmo" => TermDefinition.new("srmo", id: "https://w3id.org/srmo#", simple: true, prefix: true),
      ...
      "srt" => TermDefinition.new("srt", id: "http://w3id.org/srt#", simple: true, prefix: true),
      "srtun" => TermDefinition.new("srtun", id: "https://www.inf.bi.rub.de/srtun#", simple: true, prefix: true),
      ...
      "ssnx" => TermDefinition.new("ssnx", id: "http://purl.oclc.org/NET/ssnx/ssn#", simple: true, prefix: true),
      ...
      "sssom" => TermDefinition.new("sssom", id: "https://w3id.org/sssom/", simple: true, prefix: true),
      "st" => TermDefinition.new("st", id: "http://ns.inria.fr/sparql-template/", simple: true, prefix: true),
      ...
      "stat" => TermDefinition.new("stat", id: "http://www.w3.org/ns/posix/stat#", simple: true, prefix: true),
      ...
      "stax" => TermDefinition.new("stax", id: "https://w3id.org/stax/ontology#", simple: true, prefix: true),
      "steel" => TermDefinition.new("steel", id: "https://w3id.org/steel/ProcessOntology/", simple: true, prefix: true),
      "stencila" => TermDefinition.new("stencila", id: "http://schema.stenci.la/", simple: true, prefix: true),
      "step" => TermDefinition.new("step", id: "http://purl.org/net/step#", simple: true, prefix: true),
      "stirdata" => TermDefinition.new("stirdata", id: "https://w3id.org/stirdata/vocabulary/", simple: true, prefix: true),
      "stix" => TermDefinition.new("stix", id: "http://purl.org/cyber/stix#", simple: true, prefix: true),
      ...
      "sty" => TermDefinition.new("sty", id: "http://purl.bioontology.org/ontology/STY/", simple: true, prefix: true),
      "summa" => TermDefinition.new("summa", id: "http://purl.org/voc/summa/", simple: true, prefix: true),
      "sure" => TermDefinition.new("sure", id: "http://ns.inria.fr/sure#", simple: true, prefix: true),
      ...
      "sweet" => TermDefinition.new("sweet", id: "http://sweetontology.net/", simple: true, prefix: true),
      ...
      "taxref" => TermDefinition.new("taxref", id: "http://taxref.mnhn.fr/lod/taxon/", simple: true, prefix: true),
      "taxrefprop" => TermDefinition.new("taxrefprop", id: "http://taxref.mnhn.fr/lod/property/", simple: true, prefix: true),
      ...
      "tempo" => TermDefinition.new("tempo", id: "http://purl.org/tempo/", simple: true, prefix: true),
      "terms" => TermDefinition.new("terms", id: "http://purl.org/dc/terms/", simple: true, prefix: true),
      "tern" => TermDefinition.new("tern", id: "http://w3id.org/tern/ontologies/tern/", simple: true, prefix: true),
      "test" => TermDefinition.new("test", id: "https://test4.example.com/", simple: true, prefix: true),
      ...
      "tg" => TermDefinition.new("tg", id: "https://triplydb.com/Triply/tg/def/", simple: true, prefix: true),
      ...
      "threat" => TermDefinition.new("threat", id: "https://cve.mitre.org/", simple: true, prefix: true),
      "thub" => TermDefinition.new("thub", id: "http://vocabularis.crai.ub.edu/thub/", simple: true, prefix: true),
      ...
      "toaru" => TermDefinition.new("toaru", id: "https://metadata.moe/toaru-sparql/elements/", simple: true, prefix: true),
      ...
      "tp" => TermDefinition.new("tp", id: "https://triplydb.com/Triply/tp/def/", simple: true, prefix: true),
      ...
      "trak" => TermDefinition.new("trak", id: "https://trakmetamodel.sourceforge.io/vocab/rdf-schema.rdf#", simple: true, prefix: true),
      ...
      "tree" => TermDefinition.new("tree", id: "https://w3id.org/tree#", simple: true, prefix: true),
      "trek" => TermDefinition.new("trek", id: "https://w3id.org/trek/", simple: true, prefix: true),
      ...
      "tro" => TermDefinition.new("tro", id: "https://w3id.org/TRO/", simple: true, prefix: true),
      ...
      "tso" => TermDefinition.new("tso", id: "https://w3id.org/tso#", simple: true, prefix: true),
      "tsso" => TermDefinition.new("tsso", id: "https://scch.org/technical_standards#", simple: true, prefix: true),
      ...
      "ttrpg" => TermDefinition.new("ttrpg", id: "https://w3id.org/TTRpg#", simple: true, prefix: true),
      ...
      "ufo" => TermDefinition.new("ufo", id: "http://ufo.com/#", simple: true, prefix: true),
      "ui" => TermDefinition.new("ui", id: "http://www.w3.org/ns/ui#", simple: true, prefix: true),
      "uimo" => TermDefinition.new("uimo", id: "http://vocab.sti2.at/uimo/", simple: true, prefix: true),
      "uio" => TermDefinition.new("uio", id: "https://www.mitre.org/mparmelee/ontologies/2023/6/UserIntentOntology/", simple: true, prefix: true),
      "uiot" => TermDefinition.new("uiot", id: "http://www.w3id.org/urban-iot/core#", simple: true, prefix: true),
      ...
      "ultragaz" => TermDefinition.new("ultragaz", id: "https://ultragaz24horas.com/", simple: true, prefix: true),
      ...
      "uniprot" => TermDefinition.new("uniprot", id: "http://purl.uniprot.org/uniprot/", simple: true, prefix: true),
      ...
      "value" => TermDefinition.new("value", id: "http://gfgfd.vs/", simple: true, prefix: true),
      ...
      "vcs" => TermDefinition.new("vcs", id: "https://data.vlaanderen.be/ns/chemische_stof#", simple: true, prefix: true),
      "vdpp" => TermDefinition.new("vdpp", id: "http://data.lirmm.fr/ontologies/vdpp#", simple: true, prefix: true),
      "veelana" => TermDefinition.new("veelana", id: "http://onlyfans.com/veelana/", simple: true, prefix: true),
      ...
      "version" => TermDefinition.new("version", id: "https://version.link/", simple: true, prefix: true),
      ...
      "vhbieo" => TermDefinition.new("vhbieo", id: "https://w3id.org/vhbieo#", simple: true, prefix: true),
      ...
      "vl" => TermDefinition.new("vl", id: "https://version.link/", simple: true, prefix: true),
      "vlueprint" => TermDefinition.new("vlueprint", id: "https://vlueprint.org/schema/", simple: true, prefix: true),
      "vmm" => TermDefinition.new("vmm", id: "http://spi-fm.uca.es/spdef/models/genericTools/vmm/1.0#", simple: true, prefix: true),
      "vntourism" => TermDefinition.new("vntourism", id: "http://www.semanticweb.org/minhn/ontologies/2021/0/vntourism#", simple: true, prefix: true),
      ...
      "vph" => TermDefinition.new("vph", id: "http://purl.org/ozo/vph.owl#", simple: true, prefix: true),
      "vplan" => TermDefinition.new("vplan", id: "http://www.ifs.tuwien.ac.at/~miksa/ontologies/VPlan.owl#", simple: true, prefix: true),
      "vr" => TermDefinition.new("vr", id: "https://www.w3.org/2018/credentials/v1/", simple: true, prefix: true),
      "vra" => TermDefinition.new("vra", id: "http://purl.org/vra/", simple: true, prefix: true),
      ...
      "w3" => TermDefinition.new("w3", id: "http://www.w3.org/", simple: true, prefix: true),
      ...
      "w3geo" => TermDefinition.new("w3geo", id: "http://www.w3.org/2003/01/geo/wgs84_pos#", simple: true, prefix: true),
      "w3id" => TermDefinition.new("w3id", id: "https://w3id.org/", simple: true, prefix: true),
      ...
      "waa" => TermDefinition.new("waa", id: "http://purl.oclc.org/NET/WebApiAuthentication#", simple: true, prefix: true),
      ...
      "walmart" => TermDefinition.new("walmart", id: "https://www.amazon.de/", simple: true, prefix: true),
      ...
      "wasa" => TermDefinition.new("wasa", id: "http://vocab.sti2.at/wasa/", simple: true, prefix: true),
      ...
      "wdno" => TermDefinition.new("wdno", id: "http://www.wikidata.org/prop/novalue/", simple: true, prefix: true),
      ...
      "wds" => TermDefinition.new("wds", id: "http://www.wikidata.org/entity/statement/", simple: true, prefix: true),
      "wdt" => TermDefinition.new("wdt", id: "http://www.wikidata.org/prop/direct/", simple: true, prefix: true),
      "wdtn" => TermDefinition.new("wdtn", id: "http://www.wikidata.org/prop/direct-normalized/", simple: true, prefix: true),
      ...
      "weki" => TermDefinition.new("weki", id: "https://en.wikipedia.org/wiki/", simple: true, prefix: true),
      ...
      "wfont" => TermDefinition.new("wfont", id: "https://w3id.org/wfont#", simple: true, prefix: true),
      ...
      "wikipedia" => TermDefinition.new("wikipedia", id: "https://en.wikipedia.org/wiki/", simple: true, prefix: true),
      "wikterms" => TermDefinition.new("wikterms", id: "http://wiktionary.dbpedia.org/terms/", simple: true, prefix: true),
      "wild" => TermDefinition.new("wild", id: "http://purl.org/wild/vocab#", simple: true, prefix: true),
      ...
      "wotc" => TermDefinition.new("wotc", id: "http://purl.org/wot-catalogue#", simple: true, prefix: true),
      "wotsec" => TermDefinition.new("wotsec", id: "https://www.w3.org/2019/wot/security#", simple: true, prefix: true),
      ...
      "wrroc" => TermDefinition.new("wrroc", id: "https://w3id.org/ro/terms/workflow-run#", simple: true, prefix: true),
      ...
      "xmlns" => TermDefinition.new("xmlns", id: "http://xmlns.com/foaf/0.1/", simple: true, prefix: true),
      ...
      "yandex" => TermDefinition.new("yandex", id: "http://yandex.ru/", simple: true, prefix: true),
      "yanice" => TermDefinition.new("yanice", id: "http://yanice-boady.webflow.io/", simple: true, prefix: true),
