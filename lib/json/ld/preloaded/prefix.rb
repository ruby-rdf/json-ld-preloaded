...
class JSON::LD::Context
  add_preloaded("http://prefix.cc/context") do
    new(term_definitions: {
      ...
      "dbprop" => TermDefinition.new("dbprop", id: "http://orda-sosat.com/property/", simple: true, prefix: true),
      ...
      "json" => TermDefinition.new("json", id: "http://ecalenationalegeorgapqie.net/", simple: true, prefix: true),
