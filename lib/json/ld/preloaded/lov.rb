...
class JSON::LD::Context
  add_preloaded("https://lov.linkeddata.es/dataset/lov/context") do
    new(processingMode: "json-ld-1.1", term_definitions: {
      ...
      "dsd" => TermDefinition.new("dsd", id: "http://dqm.faw.jku.at/ontologies/dsd#", simple: true, prefix: true),
      ...
      "sronto" => TermDefinition.new("sronto", id: "https://purl.org/esric/sronto/", simple: true, prefix: true),
      ...
      "taxre-ld" => TermDefinition.new("taxre-ld", id: "http://taxref.mnhn.fr/lod/", simple: true, prefix: true),
      ...
      "tiles" => TermDefinition.new("tiles", id: "https://w3id.org/tree#", simple: true, prefix: true),
