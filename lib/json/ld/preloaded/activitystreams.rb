...
class JSON::LD::Context
  add_preloaded("https://www.w3.org/ns/activitystreams") do
    new(vocab: "_:", processingMode: "json-ld-1.0", term_definitions: {
      ...
      "authorizeClientKey" => TermDefinition.new("authorizeClientKey", id: "https://www.w3.org/ns/activitystreams#authorizeClientKey", simple: true),
      ...
      "oauthClientAuthorize" => TermDefinition.new("oauthClientAuthorize", id: "https://www.w3.org/ns/activitystreams#oauthClientAuthorize", simple: true),
      ...
      "provideClientKey" => TermDefinition.new("provideClientKey", id: "https://www.w3.org/ns/activitystreams#provideClientKey", simple: true),
