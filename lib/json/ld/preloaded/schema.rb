...
class JSON::LD::Context
  add_preloaded("http://schema.org/") do
    new(vocab: "http://schema.org/", term_definitions: {
      ...
      "competencyRequired" => TermDefinition.new("competencyRequired", id: "http://schema.org/competencyRequired", type_mapping: "@id"),
      ...
      "credentialCategory" => TermDefinition.new("credentialCategory", id: "http://schema.org/credentialCategory", type_mapping: "@id"),
      ...
      "educationalLevel" => TermDefinition.new("educationalLevel", id: "http://schema.org/educationalLevel", type_mapping: "@id"),
