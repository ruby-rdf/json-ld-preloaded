...
class JSON::LD::Context
  add_preloaded("http://schema.org/") do
    new(vocab: "http://schema.org/", processingMode: "json-ld-1.1", term_definitions: {
      ...
      "asin" => TermDefinition.new("asin", id: "http://schema.org/asin"),
      ...
      "checkoutPageURLTemplate" => TermDefinition.new("checkoutPageURLTemplate", id: "http://schema.org/checkoutPageURLTemplate"),
      ...
      "mobileUrl" => TermDefinition.new("mobileUrl", id: "http://schema.org/mobileUrl"),
      ...
      "shippingOrigin" => TermDefinition.new("shippingOrigin", id: "http://schema.org/shippingOrigin"),
