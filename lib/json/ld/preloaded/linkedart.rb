...
class JSON::LD::Context
  add_preloaded("http://linked.art/ns/v1/linked-art.json") do
    new(processingMode: "json-ld-1.1", term_definitions: {
      ...
      "encountered" => TermDefinition.new("encountered", id: "http://www.ics.forth.gr/isl/CRMsci/O19_has_found_object", type_mapping: "@id", container_mapping: "@set"),
      "encountered_by" => TermDefinition.new("encountered_by", id: "http://www.ics.forth.gr/isl/CRMsci/O19i_was_object_found_by", type_mapping: "@id", container_mapping: "@set"),
      ...
      "instance_represented_by" => TermDefinition.new("instance_represented_by", id: "https://linked.art/ns/terms/instance_represented_by", type_mapping: "@id", container_mapping: "@set"),
      ...
      "represents_instance_of_type" => TermDefinition.new("represents_instance_of_type", id: "https://linked.art/ns/terms/represents_instance_of_type", type_mapping: "@id", container_mapping: "@set"),
