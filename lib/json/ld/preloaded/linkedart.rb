...
class JSON::LD::Context
  add_preloaded("http://linked.art/ns/v1/linked-art.json") do
    new(processingMode: "json-ld-1.1", term_definitions: {
      "Acquisition" => TermDefinition.new("Acquisition", id: "http://www.cidoc-crm.org/cidoc-crm/E8_Acquisition", context: {"part_of"=>{"@id"=>"crm:P9i_forms_part_of", "@type"=>"@id", "@container"=>"@set"}, "part"=>{"@id"=>"crm:P9_consists_of", "@type"=>"@id", "@container"=>"@set"}, "member_of"=>{"@id"=>"la:member_of", "@type"=>"@id", "@container"=>"@set"}}),
      "Activity" => TermDefinition.new("Activity", id: "http://www.cidoc-crm.org/cidoc-crm/E7_Activity", context: {"part_of"=>{"@id"=>"crm:P9i_forms_part_of", "@type"=>"@id", "@container"=>"@set"}, "part"=>{"@id"=>"crm:P9_consists_of", "@type"=>"@id", "@container"=>"@set"}, "member_of"=>{"@id"=>"la:member_of", "@type"=>"@id", "@container"=>"@set"}}),
      ...
      "Appellation" => TermDefinition.new("Appellation", id: "http://www.cidoc-crm.org/cidoc-crm/E41_Appellation", context: {"part_of"=>{"@id"=>"crm:P106i_forms_part_of", "@type"=>"@id", "@container"=>"@set"}, "part"=>{"@id"=>"crm:P106_is_composed_of", "@type"=>"@id", "@container"=>"@set"}, "member_of"=>{"@id"=>"la:member_of", "@type"=>"@id", "@container"=>"@set"}}),
      "AttributeAssignment" => TermDefinition.new("AttributeAssignment", id: "http://www.cidoc-crm.org/cidoc-crm/E13_Attribute_Assignment", context: {"part_of"=>{"@id"=>"crm:P9i_forms_part_of", "@type"=>"@id", "@container"=>"@set"}, "part"=>{"@id"=>"crm:P9_consists_of", "@type"=>"@id", "@container"=>"@set"}, "member_of"=>{"@id"=>"la:member_of", "@type"=>"@id", "@container"=>"@set"}}),
      "AuthorityDocument" => TermDefinition.new("AuthorityDocument", id: "http://www.cidoc-crm.org/cidoc-crm/E32_Authority_Document"),
      "BeginningOfExistence" => TermDefinition.new("BeginningOfExistence", id: "http://www.cidoc-crm.org/cidoc-crm/E63_Beginning_of_Existence", context: {"part_of"=>{"@id"=>"crm:P9i_forms_part_of", "@type"=>"@id", "@container"=>"@set"}, "part"=>{"@id"=>"crm:P9_consists_of", "@type"=>"@id", "@container"=>"@set"}, "member_of"=>{"@id"=>"la:member_of", "@type"=>"@id", "@container"=>"@set"}}),
      "BiologicalObject" => TermDefinition.new("BiologicalObject", id: "http://www.cidoc-crm.org/cidoc-crm/E20_Biological_Object", context: {"part_of"=>{"@id"=>"crm:P46i_forms_part_of", "@type"=>"@id", "@container"=>"@set"}, "part"=>{"@id"=>"crm:P46_is_composed_of", "@type"=>"@id", "@container"=>"@set"}, "member_of"=>{"@id"=>"la:member_of", "@type"=>"@id", "@container"=>"@set"}}),
      "Birth" => TermDefinition.new("Birth", id: "http://www.cidoc-crm.org/cidoc-crm/E67_Birth", context: {"part_of"=>{"@id"=>"crm:P9i_forms_part_of", "@type"=>"@id", "@container"=>"@set"}, "part"=>{"@id"=>"crm:P9_consists_of", "@type"=>"@id", "@container"=>"@set"}, "member_of"=>{"@id"=>"la:member_of", "@type"=>"@id", "@container"=>"@set"}}),
      ...
      "Creation" => TermDefinition.new("Creation", id: "http://www.cidoc-crm.org/cidoc-crm/E65_Creation", context: {"part_of"=>{"@id"=>"crm:P9i_forms_part_of", "@type"=>"@id", "@container"=>"@set"}, "part"=>{"@id"=>"crm:P9_consists_of", "@type"=>"@id", "@container"=>"@set"}, "member_of"=>{"@id"=>"la:member_of", "@type"=>"@id", "@container"=>"@set"}}),
      ...
      "Currency" => TermDefinition.new("Currency", id: "http://www.cidoc-crm.org/cidoc-crm/E98_Currency", context: {"part_of"=>{"@id"=>"skos:broader", "@type"=>"@id", "@container"=>"@set"}, "part"=>{"@id"=>"skos:narrower", "@type"=>"@id", "@container"=>"@set"}, "member_of"=>{"@id"=>"la:member_of", "@type"=>"@id", "@container"=>"@set"}}),
      "Death" => TermDefinition.new("Death", id: "http://www.cidoc-crm.org/cidoc-crm/E69_Death", context: {"part_of"=>{"@id"=>"crm:P9i_forms_part_of", "@type"=>"@id", "@container"=>"@set"}, "part"=>{"@id"=>"crm:P9_consists_of", "@type"=>"@id", "@container"=>"@set"}, "member_of"=>{"@id"=>"la:member_of", "@type"=>"@id", "@container"=>"@set"}}),
      "DesignOrProcedure" => TermDefinition.new("DesignOrProcedure", id: "http://www.cidoc-crm.org/cidoc-crm/E29_Design_or_Procedure"),
      "Destruction" => TermDefinition.new("Destruction", id: "http://www.cidoc-crm.org/cidoc-crm/E6_Destruction", context: {"part_of"=>{"@id"=>"crm:P9i_forms_part_of", "@type"=>"@id", "@container"=>"@set"}, "part"=>{"@id"=>"crm:P9_consists_of", "@type"=>"@id", "@container"=>"@set"}, "member_of"=>{"@id"=>"la:member_of", "@type"=>"@id", "@container"=>"@set"}}),
      ...
      "Dissolution" => TermDefinition.new("Dissolution", id: "http://www.cidoc-crm.org/cidoc-crm/E68_Dissolution", context: {"part_of"=>{"@id"=>"crm:P9i_forms_part_of", "@type"=>"@id", "@container"=>"@set"}, "part"=>{"@id"=>"crm:P9_consists_of", "@type"=>"@id", "@container"=>"@set"}, "member_of"=>{"@id"=>"la:member_of", "@type"=>"@id", "@container"=>"@set"}}),
      "Document" => TermDefinition.new("Document", id: "http://www.cidoc-crm.org/cidoc-crm/E31_Document"),
      "EndOfExistence" => TermDefinition.new("EndOfExistence", id: "http://www.cidoc-crm.org/cidoc-crm/E64_End_of_Existence", context: {"part_of"=>{"@id"=>"crm:P9i_forms_part_of", "@type"=>"@id", "@container"=>"@set"}, "part"=>{"@id"=>"crm:P9_consists_of", "@type"=>"@id", "@container"=>"@set"}, "member_of"=>{"@id"=>"la:member_of", "@type"=>"@id", "@container"=>"@set"}}),
      "Event" => TermDefinition.new("Event", id: "http://www.cidoc-crm.org/cidoc-crm/E5_Event", context: {"part_of"=>{"@id"=>"crm:P9i_forms_part_of", "@type"=>"@id", "@container"=>"@set"}, "part"=>{"@id"=>"crm:P9_consists_of", "@type"=>"@id", "@container"=>"@set"}, "member_of"=>{"@id"=>"la:member_of", "@type"=>"@id", "@container"=>"@set"}}),
      "Formation" => TermDefinition.new("Formation", id: "http://www.cidoc-crm.org/cidoc-crm/E66_Formation", context: {"part_of"=>{"@id"=>"crm:P9i_forms_part_of", "@type"=>"@id", "@container"=>"@set"}, "part"=>{"@id"=>"crm:P9_consists_of", "@type"=>"@id", "@container"=>"@set"}, "member_of"=>{"@id"=>"la:member_of", "@type"=>"@id", "@container"=>"@set"}}),
      ...
      "HumanMadeFeature" => TermDefinition.new("HumanMadeFeature", id: "http://www.cidoc-crm.org/cidoc-crm/E25_Human-Made_Feature", context: {"part_of"=>{"@id"=>"crm:P46i_forms_part_of", "@type"=>"@id", "@container"=>"@set"}, "part"=>{"@id"=>"crm:P46_is_composed_of", "@type"=>"@id", "@container"=>"@set"}, "member_of"=>{"@id"=>"la:member_of", "@type"=>"@id", "@container"=>"@set"}}),
      "HumanMadeObject" => TermDefinition.new("HumanMadeObject", id: "http://www.cidoc-crm.org/cidoc-crm/E22_Human-Made_Object", context: {"part_of"=>{"@id"=>"crm:P46i_forms_part_of", "@type"=>"@id", "@container"=>"@set"}, "part"=>{"@id"=>"crm:P46_is_composed_of", "@type"=>"@id", "@container"=>"@set"}, "member_of"=>{"@id"=>"la:member_of", "@type"=>"@id", "@container"=>"@set"}}),
      "HumanMadeThing" => TermDefinition.new("HumanMadeThing", id: "http://www.cidoc-crm.org/cidoc-crm/E71_Human-Made_Thing"),
      "Identifier" => TermDefinition.new("Identifier", id: "http://www.cidoc-crm.org/cidoc-crm/E42_Identifier", context: {"part_of"=>{"@id"=>"crm:P106i_forms_part_of", "@type"=>"@id", "@container"=>"@set"}, "part"=>{"@id"=>"crm:P106_is_composed_of", "@type"=>"@id", "@container"=>"@set"}, "member_of"=>{"@id"=>"la:member_of", "@type"=>"@id", "@container"=>"@set"}}),
      ...
      "InformationObject" => TermDefinition.new("InformationObject", id: "http://www.cidoc-crm.org/cidoc-crm/E73_Information_Object", context: {"part_of"=>{"@id"=>"crm:P106i_forms_part_of", "@type"=>"@id", "@container"=>"@set"}, "part"=>{"@id"=>"crm:P106_is_composed_of", "@type"=>"@id", "@container"=>"@set"}, "member_of"=>{"@id"=>"la:member_of", "@type"=>"@id", "@container"=>"@set"}}),
      "Inscription" => TermDefinition.new("Inscription", id: "http://www.cidoc-crm.org/cidoc-crm/E34_Inscription", context: {"part_of"=>{"@id"=>"crm:P106i_forms_part_of", "@type"=>"@id", "@container"=>"@set"}, "part"=>{"@id"=>"crm:P106_is_composed_of", "@type"=>"@id", "@container"=>"@set"}, "member_of"=>{"@id"=>"la:member_of", "@type"=>"@id", "@container"=>"@set"}}),
      "Joining" => TermDefinition.new("Joining", id: "http://www.cidoc-crm.org/cidoc-crm/E85_Joining", context: {"part_of"=>{"@id"=>"crm:P9i_forms_part_of", "@type"=>"@id", "@container"=>"@set"}, "part"=>{"@id"=>"crm:P9_consists_of", "@type"=>"@id", "@container"=>"@set"}, "member_of"=>{"@id"=>"la:member_of", "@type"=>"@id", "@container"=>"@set"}}),
      "Language" => TermDefinition.new("Language", id: "http://www.cidoc-crm.org/cidoc-crm/E56_Language", context: {"part_of"=>{"@id"=>"skos:broader", "@type"=>"@id", "@container"=>"@set"}, "part"=>{"@id"=>"skos:narrower", "@type"=>"@id", "@container"=>"@set"}, "member_of"=>{"@id"=>"la:member_of", "@type"=>"@id", "@container"=>"@set"}}),
      "Leaving" => TermDefinition.new("Leaving", id: "http://www.cidoc-crm.org/cidoc-crm/E86_Leaving", context: {"part_of"=>{"@id"=>"crm:P9i_forms_part_of", "@type"=>"@id", "@container"=>"@set"}, "part"=>{"@id"=>"crm:P9_consists_of", "@type"=>"@id", "@container"=>"@set"}, "member_of"=>{"@id"=>"la:member_of", "@type"=>"@id", "@container"=>"@set"}}),
      "LegalObject" => TermDefinition.new("LegalObject", id: "http://www.cidoc-crm.org/cidoc-crm/E72_Legal_Object"),
      "LinguisticObject" => TermDefinition.new("LinguisticObject", id: "http://www.cidoc-crm.org/cidoc-crm/E33_Linguistic_Object", context: {"part_of"=>{"@id"=>"crm:P106i_forms_part_of", "@type"=>"@id", "@container"=>"@set"}, "part"=>{"@id"=>"crm:P106_is_composed_of", "@type"=>"@id", "@container"=>"@set"}, "member_of"=>{"@id"=>"la:member_of", "@type"=>"@id", "@container"=>"@set"}}),
      "Mark" => TermDefinition.new("Mark", id: "http://www.cidoc-crm.org/cidoc-crm/E37_Mark", context: {"part_of"=>{"@id"=>"crm:P106i_forms_part_of", "@type"=>"@id", "@container"=>"@set"}, "part"=>{"@id"=>"crm:P106_is_composed_of", "@type"=>"@id", "@container"=>"@set"}, "member_of"=>{"@id"=>"la:member_of", "@type"=>"@id", "@container"=>"@set"}}),
      "Material" => TermDefinition.new("Material", id: "http://www.cidoc-crm.org/cidoc-crm/E57_Material", context: {"part_of"=>{"@id"=>"skos:broader", "@type"=>"@id", "@container"=>"@set"}, "part"=>{"@id"=>"skos:narrower", "@type"=>"@id", "@container"=>"@set"}, "member_of"=>{"@id"=>"la:member_of", "@type"=>"@id", "@container"=>"@set"}}),
      "Measurement" => TermDefinition.new("Measurement", id: "http://www.cidoc-crm.org/cidoc-crm/E16_Measurement"),
      "MeasurementUnit" => TermDefinition.new("MeasurementUnit", id: "http://www.cidoc-crm.org/cidoc-crm/E58_Measurement_Unit", context: {"part_of"=>{"@id"=>"skos:broader", "@type"=>"@id", "@container"=>"@set"}, "part"=>{"@id"=>"skos:narrower", "@type"=>"@id", "@container"=>"@set"}, "member_of"=>{"@id"=>"la:member_of", "@type"=>"@id", "@container"=>"@set"}}),
      "Modification" => TermDefinition.new("Modification", id: "http://www.cidoc-crm.org/cidoc-crm/E11_Modification", context: {"part_of"=>{"@id"=>"crm:P9i_forms_part_of", "@type"=>"@id", "@container"=>"@set"}, "part"=>{"@id"=>"crm:P9_consists_of", "@type"=>"@id", "@container"=>"@set"}, "member_of"=>{"@id"=>"la:member_of", "@type"=>"@id", "@container"=>"@set"}}),
      "MonetaryAmount" => TermDefinition.new("MonetaryAmount", id: "http://www.cidoc-crm.org/cidoc-crm/E97_Monetary_Amount"),
      "Move" => TermDefinition.new("Move", id: "http://www.cidoc-crm.org/cidoc-crm/E9_Move", context: {"part_of"=>{"@id"=>"crm:P9i_forms_part_of", "@type"=>"@id", "@container"=>"@set"}, "part"=>{"@id"=>"crm:P9_consists_of", "@type"=>"@id", "@container"=>"@set"}, "member_of"=>{"@id"=>"la:member_of", "@type"=>"@id", "@container"=>"@set"}}),
      "Name" => TermDefinition.new("Name", id: "http://www.cidoc-crm.org/cidoc-crm/E33_E41_Linguistic_Appellation", context: {"part_of"=>{"@id"=>"crm:P106i_forms_part_of", "@type"=>"@id", "@container"=>"@set"}, "part"=>{"@id"=>"crm:P106_is_composed_of", "@type"=>"@id", "@container"=>"@set"}, "member_of"=>{"@id"=>"la:member_of", "@type"=>"@id", "@container"=>"@set"}}),
      "PartAddition" => TermDefinition.new("PartAddition", id: "http://www.cidoc-crm.org/cidoc-crm/E79_Part_Addition", context: {"part_of"=>{"@id"=>"crm:P9i_forms_part_of", "@type"=>"@id", "@container"=>"@set"}, "part"=>{"@id"=>"crm:P9_consists_of", "@type"=>"@id", "@container"=>"@set"}, "member_of"=>{"@id"=>"la:member_of", "@type"=>"@id", "@container"=>"@set"}}),
      "PartRemoval" => TermDefinition.new("PartRemoval", id: "http://www.cidoc-crm.org/cidoc-crm/E80_Part_Removal", context: {"part_of"=>{"@id"=>"crm:P9i_forms_part_of", "@type"=>"@id", "@container"=>"@set"}, "part"=>{"@id"=>"crm:P9_consists_of", "@type"=>"@id", "@container"=>"@set"}, "member_of"=>{"@id"=>"la:member_of", "@type"=>"@id", "@container"=>"@set"}}),
      "Payment" => TermDefinition.new("Payment", id: "https://linked.art/ns/terms/Payment", context: {"part_of"=>{"@id"=>"crm:P9i_forms_part_of", "@type"=>"@id", "@container"=>"@set"}, "part"=>{"@id"=>"crm:P9_consists_of", "@type"=>"@id", "@container"=>"@set"}, "member_of"=>{"@id"=>"la:member_of", "@type"=>"@id", "@container"=>"@set"}}),
      "Period" => TermDefinition.new("Period", id: "http://www.cidoc-crm.org/cidoc-crm/E4_Period", context: {"part_of"=>{"@id"=>"crm:P9i_forms_part_of", "@type"=>"@id", "@container"=>"@set"}, "part"=>{"@id"=>"crm:P9_consists_of", "@type"=>"@id", "@container"=>"@set"}, "member_of"=>{"@id"=>"la:member_of", "@type"=>"@id", "@container"=>"@set"}}),
      ...
      "PhysicalFeature" => TermDefinition.new("PhysicalFeature", id: "http://www.cidoc-crm.org/cidoc-crm/E26_Physical_Feature", context: {"part_of"=>{"@id"=>"crm:P46i_forms_part_of", "@type"=>"@id", "@container"=>"@set"}, "part"=>{"@id"=>"crm:P46_is_composed_of", "@type"=>"@id", "@container"=>"@set"}, "member_of"=>{"@id"=>"la:member_of", "@type"=>"@id", "@container"=>"@set"}}),
      "PhysicalHumanMadeThing" => TermDefinition.new("PhysicalHumanMadeThing", id: "http://www.cidoc-crm.org/cidoc-crm/E24_Physical_Human-Made_Thing", context: {"part_of"=>{"@id"=>"crm:P46i_forms_part_of", "@type"=>"@id", "@container"=>"@set"}, "part"=>{"@id"=>"crm:P46_is_composed_of", "@type"=>"@id", "@container"=>"@set"}, "member_of"=>{"@id"=>"la:member_of", "@type"=>"@id", "@container"=>"@set"}}),
      "PhysicalObject" => TermDefinition.new("PhysicalObject", id: "http://www.cidoc-crm.org/cidoc-crm/E19_Physical_Object", context: {"part_of"=>{"@id"=>"crm:P46i_forms_part_of", "@type"=>"@id", "@container"=>"@set"}, "part"=>{"@id"=>"crm:P46_is_composed_of", "@type"=>"@id", "@container"=>"@set"}, "member_of"=>{"@id"=>"la:member_of", "@type"=>"@id", "@container"=>"@set"}}),
      "PhysicalThing" => TermDefinition.new("PhysicalThing", id: "http://www.cidoc-crm.org/cidoc-crm/E18_Physical_Thing", context: {"part_of"=>{"@id"=>"crm:P46i_forms_part_of", "@type"=>"@id", "@container"=>"@set"}, "part"=>{"@id"=>"crm:P46_is_composed_of", "@type"=>"@id", "@container"=>"@set"}, "member_of"=>{"@id"=>"la:member_of", "@type"=>"@id", "@container"=>"@set"}}),
      "Place" => TermDefinition.new("Place", id: "http://www.cidoc-crm.org/cidoc-crm/E53_Place", context: {"part_of"=>{"@id"=>"crm:P89_falls_within", "@type"=>"@id", "@container"=>"@set"}, "part"=>{"@id"=>"crm:P89i_contains", "@type"=>"@id", "@container"=>"@set"}, "member_of"=>{"@id"=>"la:member_of", "@type"=>"@id", "@container"=>"@set"}}),
      ...
      "Production" => TermDefinition.new("Production", id: "http://www.cidoc-crm.org/cidoc-crm/E12_Production", context: {"part_of"=>{"@id"=>"crm:P9i_forms_part_of", "@type"=>"@id", "@container"=>"@set"}, "part"=>{"@id"=>"crm:P9_consists_of", "@type"=>"@id", "@container"=>"@set"}, "member_of"=>{"@id"=>"la:member_of", "@type"=>"@id", "@container"=>"@set"}}),
      "PropositionalObject" => TermDefinition.new("PropositionalObject", id: "http://www.cidoc-crm.org/cidoc-crm/E89_Propositional_Object", context: {"part_of"=>{"@id"=>"crm:P148i_is_component_of", "@type"=>"@id", "@container"=>"@set"}, "part"=>{"@id"=>"crm:P148_has_component", "@type"=>"@id", "@container"=>"@set"}, "member_of"=>{"@id"=>"la:member_of", "@type"=>"@id", "@container"=>"@set"}}),
      "Purchase" => TermDefinition.new("Purchase", id: "http://www.cidoc-crm.org/cidoc-crm/E96_Purchase", context: {"part_of"=>{"@id"=>"crm:P9i_forms_part_of", "@type"=>"@id", "@container"=>"@set"}, "part"=>{"@id"=>"crm:P9_consists_of", "@type"=>"@id", "@container"=>"@set"}, "member_of"=>{"@id"=>"la:member_of", "@type"=>"@id", "@container"=>"@set"}}),
      "Q9_is_expressed_in_terms_of" => TermDefinition.new("Q9_is_expressed_in_terms_of", id: "geo:Q9_is_expressed_in_terms_of", type_mapping: "@id"),
      "Q9i_terms_express" => TermDefinition.new("Q9i_terms_express", id: "geo:Q9i_terms_express", type_mapping: "@id"),
      ...
      "Right" => TermDefinition.new("Right", id: "http://www.cidoc-crm.org/cidoc-crm/E30_Right", context: {"part_of"=>{"@id"=>"crm:P148i_is_component_of", "@type"=>"@id", "@container"=>"@set"}, "part"=>{"@id"=>"crm:P148_has_component", "@type"=>"@id", "@container"=>"@set"}, "member_of"=>{"@id"=>"la:member_of", "@type"=>"@id", "@container"=>"@set"}}),
      ...
      "Site" => TermDefinition.new("Site", id: "http://www.cidoc-crm.org/cidoc-crm/E27_Site", context: {"part_of"=>{"@id"=>"crm:P46i_forms_part_of", "@type"=>"@id", "@container"=>"@set"}, "part"=>{"@id"=>"crm:P46_is_composed_of", "@type"=>"@id", "@container"=>"@set"}, "member_of"=>{"@id"=>"la:member_of", "@type"=>"@id", "@container"=>"@set"}}),
      "SpacetimeVolume" => TermDefinition.new("SpacetimeVolume", id: "http://www.cidoc-crm.org/cidoc-crm/E92_Spacetime_Volume"),
      "SymbolicObject" => TermDefinition.new("SymbolicObject", id: "http://www.cidoc-crm.org/cidoc-crm/E90_Symbolic_Object", context: {"part_of"=>{"@id"=>"crm:P106i_forms_part_of", "@type"=>"@id", "@container"=>"@set"}, "part"=>{"@id"=>"crm:P106_is_composed_of", "@type"=>"@id", "@container"=>"@set"}, "member_of"=>{"@id"=>"la:member_of", "@type"=>"@id", "@container"=>"@set"}}),
      ...
      "TimeSpan" => TermDefinition.new("TimeSpan", id: "http://www.cidoc-crm.org/cidoc-crm/E52_Time-Span", context: {"part_of"=>{"@id"=>"crm:P86_falls_within", "@type"=>"@id", "@container"=>"@set"}, "part"=>{"@id"=>"crm:P86i_contains", "@type"=>"@id", "@container"=>"@set"}, "member_of"=>{"@id"=>"la:member_of", "@type"=>"@id", "@container"=>"@set"}}),
      "Title" => TermDefinition.new("Title", id: "http://www.cidoc-crm.org/cidoc-crm/E35_Title", context: {"part_of"=>{"@id"=>"crm:P106i_forms_part_of", "@type"=>"@id", "@container"=>"@set"}, "part"=>{"@id"=>"crm:P106_is_composed_of", "@type"=>"@id", "@container"=>"@set"}, "member_of"=>{"@id"=>"la:member_of", "@type"=>"@id", "@container"=>"@set"}}),
      "TransferOfCustody" => TermDefinition.new("TransferOfCustody", id: "http://www.cidoc-crm.org/cidoc-crm/E10_Transfer_of_Custody", context: {"part_of"=>{"@id"=>"crm:P9i_forms_part_of", "@type"=>"@id", "@container"=>"@set"}, "part"=>{"@id"=>"crm:P9_consists_of", "@type"=>"@id", "@container"=>"@set"}, "member_of"=>{"@id"=>"la:member_of", "@type"=>"@id", "@container"=>"@set"}}),
      "Transformation" => TermDefinition.new("Transformation", id: "http://www.cidoc-crm.org/cidoc-crm/E81_Transformation", context: {"part_of"=>{"@id"=>"crm:P9i_forms_part_of", "@type"=>"@id", "@container"=>"@set"}, "part"=>{"@id"=>"crm:P9_consists_of", "@type"=>"@id", "@container"=>"@set"}, "member_of"=>{"@id"=>"la:member_of", "@type"=>"@id", "@container"=>"@set"}}),
      "Type" => TermDefinition.new("Type", id: "http://www.cidoc-crm.org/cidoc-crm/E55_Type", context: {"part_of"=>{"@id"=>"skos:broader", "@type"=>"@id", "@container"=>"@set"}, "part"=>{"@id"=>"skos:narrower", "@type"=>"@id", "@container"=>"@set"}, "member_of"=>{"@id"=>"la:member_of", "@type"=>"@id", "@container"=>"@set"}}),
      ...
      "VisualItem" => TermDefinition.new("VisualItem", id: "http://www.cidoc-crm.org/cidoc-crm/E36_Visual_Item", context: {"part_of"=>{"@id"=>"crm:P106i_forms_part_of", "@type"=>"@id", "@container"=>"@set"}, "part"=>{"@id"=>"crm:P106_is_composed_of", "@type"=>"@id", "@container"=>"@set"}, "member_of"=>{"@id"=>"la:member_of", "@type"=>"@id", "@container"=>"@set"}}),
      ...
      "assigned_property" => TermDefinition.new("assigned_property", id: "http://www.cidoc-crm.org/cidoc-crm/P177_assigned_property_type", type_mapping: "@vocab"),
      ...
      "related_from_by" => TermDefinition.new("related_from_by", id: "https://linked.art/ns/terms/related_from_by", type_mapping: "@id", container_mapping: "@set"),
      "related_to_by" => TermDefinition.new("related_to_by", id: "https://linked.art/ns/terms/related_to_by", type_mapping: "@id", container_mapping: "@set"),
      "relates_from" => TermDefinition.new("relates_from", id: "https://linked.art/ns/terms/relates_from", type_mapping: "@id"),
      "relates_to" => TermDefinition.new("relates_to", id: "https://linked.art/ns/terms/relates_to", type_mapping: "@id"),
