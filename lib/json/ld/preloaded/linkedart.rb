...
class JSON::LD::Context
  add_preloaded("http://linked.art/ns/v1/linked-art.json") do
    new(processingMode: "json-ld-1.1", term_definitions: {
      ...
      "PropertyInterest" => TermDefinition.new("PropertyInterest", id: "https://linked.art/ns/terms/PropertyInterest", context: {"part"=>{"@id"=>"la:interest_part", "@type"=>"@id", "@container"=>"@set"}, "part_of"=>{"@id"=>"la:interest_part_of", "@type"=>"@id", "@container"=>"@set"}, "member_of"=>{"@id"=>"la:member_of", "@type"=>"@id", "@container"=>"@set"}}),
      ...
      "interest_part" => TermDefinition.new("interest_part", id: "https://linked.art/ns/terms/interest_part", type_mapping: "@id", container_mapping: "@set"),
      "interest_part_of" => TermDefinition.new("interest_part_of", id: "https://linked.art/ns/terms/interest_part_of", type_mapping: "@id"),
